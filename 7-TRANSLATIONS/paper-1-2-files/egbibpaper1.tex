...
%         Prolonged darkness & 14 & 11.97 \\
%         Lost lands and lakes & 12 & 10.26 \\
%         % Aerial falls: hail, gold, gravel, stones, dust & 11 & 9.40 \\
%         Cyclonic winds & 10 & 8.55 \\
%         % Lightning & 10 & 8.55 \\
%         % Description of celestial visitor & 9 & 7.69 \\
%         % Break-up and fall of celestial visitor & 9 & 7.69 \\
%         Axial/rotational changes & 9 & 7.69 \\
%         Boiling rivers/lakes/oceans & 8 & 6.84 \\
%         % Aerial falls: combustible/resinous materials & 7 & 5.98 \\
%         % References to pre-Diluvian civilisation & 7 & 5.98 \\
%         % Aerial falls: ferruginous substances & 6 & 5.13 \\
%         % Poisoned atmosphere & 4 & 3.42 \\
%         % The coming of ice & 3 & 2.56 \\
%         % Effects on vegetation & 3 & 2.56 \\
%         % Steam & 2 & 1.71 \\
%         \bottomrule
%     \end{tabular}
%     \caption{Occurrences of Catastrophic Effects in Stories}
...
%    % \includegraphics[width=1\linewidth]{b.png}
% \end{center}
%    \caption{TODO this will show a 2d graphic of salt and marine fossils}
% \label{fig:1}
% \label{fig:onecol}
% \end{figure}
...
% \caption{A diagram of the differential, patterned karst erosion caused by a sustained, temporary oceanic displacement.}
% \label{fig:1}
% \end{figure*}
...
% \end{center}
%    \caption{The interior shafts and chambers of the Khufu Pyramid, which The Ethical Skeptic believes to have been a tripartite geophysical monitoring observatory.}
% \label{fig:1}
% \label{fig:onecol}
% \end{figure}
...
% \end{center}
%    \caption{A diagram of the celestial star map drawn into a rock in one of the Queen's star shafts \cite{28}.}
% \label{fig:1}
% \label{fig:onecol}
% \end{figure}
...
% \end{center}
%    \caption{The phase change from HCP-Fe to FCC-Fe, which releases kinetic energy \cite{28}.}
% \label{fig:11}
% \label{fig:onecol}
% \end{figure}
...
% \end{center}
%    \caption{The LLVP (large low-velocity shear province) structures in the Earth's mantle, and how they are formed \cite{28,39}.}
% \label{fig:12}
% \label{fig:onecol}
% \end{figure}
