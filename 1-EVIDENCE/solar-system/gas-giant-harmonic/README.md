...
3. See `EVIDENCE/cataclysm-remnants/paleomagnetic` for varved clay date info.

## Gas giant harmonic compared with ice data

The gas giant harmonic may align well with bond event and ice core-temperature data. Check `EVIDENCE/cataclysm-remnants/ice` for that analysis.
