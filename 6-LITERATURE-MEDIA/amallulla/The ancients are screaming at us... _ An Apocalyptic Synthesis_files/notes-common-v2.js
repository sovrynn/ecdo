...
new Image().src=document.location.protocol+'//web.archive.org/web/20220315044036/https://pixel.wp.com/g.gif?v=wpcom-no-pv&x_'+group+'='+names+'&baba='+Math.random();},getKeycode:function(key_event){key_event=key_event||window.event;if(key_event.target)
...
$spinner=$('<img class="gifspinner" src="//web.archive.org/web/20220315044036/https://s0.wp.com/wp-content/mu-plugins/notes/images/loading.gif" />');$spinner.css({height:len,width:len});$el.html($spinner);return $el;};})(typeof exports!=="undefined"&&exports!==null?exports:this,window.jQuery);}).call(this);

}
/*
     FILE ARCHIVED ON 04:40:36 Mar 15, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 20:52:55 Sep 04, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 89.238
  LoadShardBlock: 3759.536 (3)
  PetaboxLoader3.datanode: 3735.393 (5)
  load_resource: 424.641
  PetaboxLoader3.resolve: 119.22
  loaddict: 159.959
*/