...
(function($){var __autoCacheBusterNotesPanel='calypso-4917-4292-g958536318a';var wpNotesArgs=window.wpNotesArgs||{},cacheBuster=wpNotesArgs.cacheBuster||__autoCacheBusterNotesPanel,iframeUrl=wpNotesArgs.iframeUrl||'https://web.archive.org/web/20220315074002/https://widgets.wp.com/notes/',iframeAppend=wpNotesArgs.iframeAppend||'',iframeScroll=wpNotesArgs.iframeScroll||"no",wideScreen=wpNotesArgs.wide||false,hasToggledPanel=false,iframePanelId,iframeFrameId;var wpntView=Backbone.View.extend({el:'#wp-admin-bar-notes',hasUnseen:null,initialLoad:true,count:null,iframe:null,iframeWindow:null,messageQ:[],iframeSpinnerShown:false,isJetpack:false,linkAccountsURL:false,currentMasterbarActive:false,initialize:function(){var t=this;var matches=navigator.appVersion.match(/MSIE (\d+)/);if(matches&&parseInt(matches[1],10)<8){var $panel=t.$('#'+iframePanelId);var $menuItem=t.$('.ab-empty-item');if(!$panel.length||!$menuItem.length){return;}
var offset=t.$el.offset();t.$('.ab-item').removeClass('ab-item');t.$('#wpnt-notes-unread-count').html('?');$panel.html(' \
					...
					<img src="https://web.archive.org/web/20220315074002/http://i2.wp.com/wordpress.com/wp-content/mu-plugins/notes/images/jetpack-notes-2x.png" /> \
					<p class="wpnt-ie-note"> \
					Please <a href="https://web.archive.org/web/20220315074002/http://browsehappy.com" target="_blank">upgrade your browser</a> to keep using notifications. \
...
if(event.origin!='https://web.archive.org/web/20220315074002/https://widgets.wp.com'){return;}
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 24.703
  LoadShardBlock: 3810.41 (3)
  PetaboxLoader3.datanode: 3848.48 (5)
  load_resource: 850.17
  PetaboxLoader3.resolve: 581.08
  loaddict: 205.12
*/