...
This catalog outlines various geological anomalies, including chemical, physical, and structural discrepancies observed through deep drilling, seismic probing, and other methods, challenging existing theories and models of Earth's composition and processes as of 2023.
...
The anomalous abundances of some noble gases, observed as either higher or lower than expected according to established theories about Earth's origin and evolution, were noted and discussed in a study on miscellaneous chemical and physical anomalies associated with inner Earth.
...
The text discusses anomalies in the Earth's atmosphere related to the depletion of helium-4, the presence of helium-3, and the absence of xenon, prompting reevaluations of geological and planetary material assumptions. (No specific dates are mentioned in the text.)
...
Deep drilling projects, such as those conducted on the Kola Peninsula, have revealed unexpected temperature and density profiles, fractured rocks with circulating fluids, and elusive geological discontinuities, challenging conventional geological models and highlighting the limitations of surface-based measurements since the late 20th century.
...
The text summarizes various geological anomalies discovered across the globe, including the Laurentian rock discovery dating back 1.3-1.6 billion years, and other mysteries ranging from buried magnetic anomalies to deep-life findings and gravity variations, highlighting ongoing puzzles in geological studies.
...
The text discusses several anomalies related to mid-plate volcanism, including the emergence of hot spots, inconsistencies in the Hawaiian hot-spot tracks, the scarcity of continental hot spots, and the non-random distribution of hot spots, challenging current theories on plate tectonics and thermal plumes.
...
This text explores various correlations and anomalies related to thermal-plume activity, including a dearth of continental hot-spot tracks noted in ECH3, the clustering of hot spots along geoid highs observed in X1, and possible periodic mechanisms proposed around X2, while challenging existing theories on geological and biological impacts over periods of 20-30 million years.
...
Recent seismic probing has revealed intricate structures and widespread stratifications in the Earth's core, mantle, and crust, challenging established geological theories and presenting a more complex picture of the planet's internal composition as of EQA reports in [year]. Note: Since the year is not specified in the original text, you may need to provide or infer the year for accuracy.
...
By the early 1980s, advances in seismic tomography revealed significant lateral inhomogeneities in the Earth's lower mantle, including a slab-like anomaly beneath the San Andreas fault and high-velocity channels that may be remnants of ancient subduction zones.
...
In presentations from 2023, geophysicists discussed the concept of "mountainous" features at the Earth's core-mantle boundary, ranging up to 10 kilometers in variation, while also noting discrepancies in seismic data interpretations that suggest these structures might be either real physical formations or artifacts of data processing.
- [FRAIL EE SS](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#frail-ee-ss)
Analysis of whole-earth vibrations conducted in recent studies has revealed irregularities in the Earth's outer core at the core-mantle boundary, with significant findings suggesting the presence of "mountain"-like and "valley"-like structures detected through seismic tomography. Note: The text does not specify particular dates, so this summary includes the general timeframe implied by "recent studies."
...
The text discusses the discovery of seismic reflectors in the lower crust and upper mantle, noting their prevalence, anomalous concentrations, deceptive nature, and recent findings down to 100 kilometers depth, highlighting uncertainties about their physical nature and distribution. (Note: The text does not specify particular dates, so this summary includes the key information without specific dates.)
...
Recent studies have revealed that the Moho boundary is more complex than previously thought, while debates continue about the nature of the 670-km discontinuity and other velocity changes in the upper mantle at 220, 400, and 520 km depths, indicating varied geological structures and potential phase transitions.
...
In the mantle, channels and zones exhibit smoother variations in seismic velocities compared to discontinuities, potentially indicating temperature changes, but their exact nature remains unclear as of the latest geological studies.
...
The text discusses several anomalies in the Earth's mantle, including the absence of the Low-Velocity Zone under continents, the mysterious D" layer near the core-mantle boundary, geographically limited zones with abnormal seismic velocities, and seismic-velocity anisotropy, challenging current geological theories. (No specific dates mentioned in the text.)
...
In 2023, researchers identified possible structural anomalies in Earth's inner core, including an apparent prolate shape and potential heterogeneity, challenging existing theories about its composition and behavior.
...
Seismic tomography challenges the two-zone mantle model by suggesting continuous descending convection currents from the surface to the core-mantle boundary, while the lack of identifiable surface signatures from convection cells puzzles geologists (no specific dates provided).
...
The text discusses deep-focus earthquakes, which occur at depths exceeding 70 kilometers and are considered puzzling in geophysics due to their unconventional mechanisms, without specifying particular dates.
...
This catalog outlines various anomalies in geological and evolutionary theories, including debates over catastrophic events versus uniformity, the accuracy of the geological time scale, patterns of biological evolution, the validity of plate tectonics, and significant gaps in the stratigraphic record, as noted by geologists since early times up to recent observations like those in the Grand Canyon.
- [AN UNCONFORMITY](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#an-unconformity)
The Grand Canyon shows an unconformity with over 200 million years of rocks from the Ordovician and Silurian periods missing, along with an additional 20 million years missing higher up, as evidenced by the presence of the Temple Butte Limestone and the Supai formation.
...
At this location, approximately 20 million years of Pennsylvanian time and over 100 million years of Ordovician, Silurian, and Lower Devonian periods are missing between the Redwall Formation and the Temple Butte Formation, totaling more than 200 million years of unaccounted geological history according to mainstream geologists.
...
The Permian-Triassic unconformity on the Colorado Plateau, dating back 245 million years, marks a significant mass extinction period despite geological evidence suggesting a blending of the two periods due to poorly marked boundaries in some areas.
...
The Salt Range in Pakistan shows significant faunal changes across the Permo-Triassic boundary without a clear physical separation between the Permian and Triassic rock layers.
...
In Canada, two significant paraconformities exist where Lower Cretaceous beds overlay Lower Carboniferous in Banff, Alberta, and Cretaceous beds cover Devonian limestone near Lake Athabaska, spanning extensive time intervals without apparent depositional or erosional breaks.
...
In the Indian Ocean, as revealed by the Deep Sea Drilling Project in the 1970s, significant gaps up to 50 million years long were discovered in sedimentary records, challenging earlier continuous sedimentation models and highlighting disruptions in sedimentation processes correlated with climatic events.
...
The geological record, assessed through sedimentation rates, indicates that existing strata represent only a small fraction of geological time, suggesting the incompleteness of the record, as consistently shown by geological research.
...
Woodmorappe's work reveals that over two-thirds of the Earth’s land surface hosts five or fewer geological periods, challenging the completeness of the geological record and highlighting significant gaps, particularly after his research published in 1996.
...
The text describes four anomalies in sedimentary strata—radical facies changes, fossil-content variations, large-scale splitting, and interfingering of diverse strata—that challenge conventional geological interpretations and the reliability of using fossils as time markers.
- [Inverted Strata](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#inverted-strata)
The text discusses five anomalies related to inverted strata, including superimposed older rocks and sharp fault contacts, which challenge established geological theories and prompt ongoing debates among scientists. (No specific dates are mentioned in the text.)
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#anomalies)
The Heart Mountain phenomenon, reclassified from an overthrust fault to a complex fault system, and the Lewis Overthrust, a classic low-angle thrust fault, both in the Rocky Mountains, highlight unique geological inversion phenomena involving older rocks overlying younger ones, with the Heart Mountain case being reevaluated more recently.
...
The text discusses several geological anomalies, including the Chief Mountain contact zone, the Lewis Overthrust movement, the Moine Overthrust interpretation debate, Appalachian thrust faults, and the Glarus Overthrust evidence, as well as the mechanical paradox of thrust faulting, highlighting complex tectonic forces and debates in geology from the Cretaceous period up to modern systematic seismic probing efforts.
...
In 2023, the Hubbert-Rubey pore-water-pressure model was discussed for its limitations in universal application, while Price's dislocation model, though promising, was introduced as a newer concept in the evolving understanding of thrust faults.
...
The Cambrian-Precambrian unconformity, a global geological phenomenon indicating a significant break in rock layers and suggesting catastrophic events around 541 million years ago, highlights the challenges in understanding Earth's historical transitions.
...
The text discusses various anomalies in rhythmites and cyclothems, including unexplained cyclicity, correlations with astronomical phenomena, persistent patterns, contradictions to geological dogmas, and discrepancies in duration estimates, suggesting gaps in current geological theories and the need for reevaluation of sedimentary processes and timelines. (Note: The text does not specify particular dates, so the summary focuses on the content rather than specific dates.)
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#anomalies)
The text discusses various geological anomalies and estimations, including challenges to the long-term stability of thin laminae, peculiar fossil preservation methods, reevaluations of epochs' durations (such as L.D. Stamp's estimate of 23 million years for the Oligocene and half of the Miocene), and the significance of sedimentary cycles and rhythms from different periods, ranging from the Eocene to the Triassic, with key insights presented up to the Permian Castile Formation. Important dates mentioned include the Oligocene and Miocene periods discussed around 1960s based on L.D. Stamp's work.
...
The text describes various lithological types including pebbly, coarse to fine sandstones, interbedded assemblages, carbonaceous siltstone and shale, and coal, indicating diverse depositional environments ranging from high-energy to quiet conditions over time. (No specific dates are mentioned.)
...
During the Carboniferous Period, distinct cyclic sedimentary sequences, known as cyclothems, varied regionally but were widely distributed globally, reflecting climatic changes and orbital mechanics, particularly evident in the recognition of Milankovitch cycles in Kansas cyclothems.
...
The debate over the relationship between coal seams and fireclays, along with the great thickness of fireclays, challenges traditional views on coal formation, particularly given the absence of marine fossils in ancient fireclay deposits, which contrasts with modern peat bog observations (no specific dates provided in the text).
...
The cyclothem concept, developed in the American interior during the Pennsylvanian period, has been subject to ongoing debates since its recognition in the mid-20th century, with various theories proposing different formation mechanisms such as tectonic and glacial influences, and regional variations highlighting the complexity of geological processes. (Note: The mid-20th century is implied as the key period for the development and recognition of the cyclothem concept.)
...
In Dumfriesshire, a 145-foot thickness cycle detected in the Lower Carboniferous period indicates alternating marine and nonmarine influences, suggesting isostatic mechanisms as a possible cause for this cyclical trend.
...
The text discusses distinct cyclical patterns in New Mexico's Pennsylvanian limestone lacking coal deposits and the presence of oil-bearing shales in Scottish cyclothems, both observed during the Carboniferous period.
...
During the Devonian Period, cyclic sedimentation patterns were observed in both the Upper Devonian Catskill Delta with a 100,000-year cycle linked to climatic variations and the Lower Old Red Sandstone deposits of South Wales, reflecting ancient river dynamics and potential tectonic influences.
...
The distinct red-striped rhythmite in the Silurian Clinton Formation, reflecting intertidal conditions, highlights how alternating tidal environments shaped the cyclic units of this period. Note: The text does not specify particular dates, so the summary focuses on the content provided.
...
During the Ordovician Period, the recognition of cyclic repetition of limestone and dolomite in Maryland provided insights into the tectonic influences and structural formations that shaped the region's geology. (No specific dates were provided in the text.)
...
In North America, the identification of "Grand Cycles" during the Cambrian Period highlights the complex sedimentary processes and dynamic geological activities on passive continental margins. (No specific dates were provided in the text for the identification, so the sentence does not include dates.)
...
In the Late Precambrian period, an anomaly in the sunspot-cycle signal was detected in rhythmites from a South Australian periglacial lake, leading to a reinterpretation of laminae from annual varves to records of lunar tidal cycles after the recognition of a fortnightly pattern.
...
The Solor Church Formation shows cyclic sedimentation indicating interactions between sedimentary and tectonic processes, with banded iron formations posing persistent challenges regarding their widespread presence and origin, as studied in recent geological research.
...
The debate over cyclic sedimentation, which traditionally emphasizes climatic and tectonic controls but increasingly acknowledges the influence of astronomical cycles and terrestrial forces, could be significantly altered by new evidence linking coal-bearing cyclothems to a shorter rhythm or periodic tsunamis from impacts, challenging existing geological paradigms.
...
The text discusses several geological anomalies, including undisturbed ancient sediments, unconsolidated ancient sediments, vertical stacking of hydrocarbon deposits, multistory sandstones, and continent-type rocks in the ocean, which challenge traditional geological interpretations and suggest more complex formation processes than previously thought. (No specific dates are mentioned in the text.)
...
The text discusses the discovery of continental rocks in various deep ocean locations, ranging from the North Brazilian Submarine Ridge (with Miocene ooze about 10 million years old) to the Caribbean Basin (with granite pebbles suggesting a subsided section of continental crust), highlighting complex geological histories spanning from the late Jurassic period to the Miocene era.
- [Exotic Terranes](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#exotic-terranes)
This text summarizes the complex geological histories of various terranes across North America, including Alaska's 50 unique terranes, the mid-ocean origin of the Marin County terrane, the 300 million-year-old Wrangellia terrane, and others like Salinia, Laytonville blocks, Carolina Slate Belt, and Florida, all of which have traveled significant distances over millions of years.
...
Contrary to previous beliefs, North America's core, as revealed recently, is composed of a collage of several older cratons that merged together, each older than 2.5 billion years. Note: The text does not specify particular dates, so this summary includes the key information without adding specific dates beyond the reference to "2.5 billion years."
- [Asia](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#asia)
The Tokoro Belt in Hokkaido, Japan, which indicates an equatorial origin from the early Cretaceous period, contains significant geological evidence despite lacking a melange matrix.
- [South America](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#south-america)
Studies in the Lancones basin of northwestern Peru reveal a unique paleomagnetic signature indicating the accretion of a continental terrane during the Early to Late Cretaceous period.
- [Europe](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#europe)
The Caledonian terrains in Scotland and the hypothesis about the Adria microplate's African origins highlight the complex geological history and tectonic interactions in Europe, spanning millions of years.
- [Other Continents](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#other-continents)
The text notes that no significant terrane data have been collected from Australia, Africa, or Antarctica, highlighting a limited understanding of global terrane distributions as of an unspecified recent date.
...
The text discusses several geological anomalies including the eruption of anorthosite belts from 700 to 1,000 million years ago, the Andesite Line, the origins of greenstone belts, the red granite-rhyolite belt in North America, and the Dupal anomaly, each highlighting unique geological formations and debates.
...
In various locations including Central Russia, the Hebrides, near Juneau, Alaska, Spencer Gulf, South Australia, near Tambora Volcano in East Indies, off Western Australia, and the Soviet Arctic, significant local magnetic anomalies were observed during different periods from 1900 to 1945, causing compass needles to deflect or behave abnormally.
...
The text discusses various magnetic anomalies caused by natural and man-made phenomena, including lightning-induced anomalies in rock formations (noted in Great Britain), magnetic changes due to the creation of artificial lakes in Australia, and potential magnetic signatures of buried impact structures related to ancient extinction events in Mexico.
...
Observations of magnetic anomalies in various oceans, including the North Pacific, Western Pacific, and Atlantic, have revealed inconsistencies with plate tectonic theories and prompted reevaluations of dating methods and geological models as of recent studies.
...
The text discusses various anomalies in magnetic profiles of the sea floor, including asymmetry in magnetic profiles, decreasing anomaly amplitude with distance, fine structure revelations, dating uncertainties, discontinuities in magnetic stripes, localized anomalies, low anomalies in the Pacific Jurassic Quiet Zone, skewness in Atlantic anomalies, subsurface origins, and implications for sea-floor spreading and the expanding-Earth hypothesis, highlighting challenges to traditional plate tectonic models. (Key dates mentioned: before 153 million years ago)
...
The text discusses several geomagnetic anomalies including the Canadian Magnetic Anomaly discovered in 1957, the Bangui Anomaly centered at 6°N, 20°E, stationary lobe-like features observed from 1715 to 1980, and the Paris Basin Magnetic Anomaly, each presenting unique mysteries about Earth's magnetic field.
...
In 2023, several electrical conductivity anomalies were discovered globally, including eddies of earth currents, a hot spot under the Andes, conductivity variations in Northern France, channels in Australia, a current in the Pacific Northwest, deep conductivity in Arizona, and a central plains anomaly in North America, challenging earlier assumptions about the dryness of the lower crust.
...
The text discusses several anomalies and secular variations in the geomagnetic field, including a tilted and possibly offset geomagnetic axis, a significant non-dipole field, unpredictable changes in the non-dipole component, and complex circulation patterns in the Earth's core, challenging current dynamo theories (no specific dates provided).
...
Since 1835, the geomagnetic field has shown a steady decrease of about 0.05% per year, raising concerns about its future stability and potential practical consequences, including periods of zero geomagnetic field during pole reversals.
...
Observations indicate a significant westward drift of the non-dipole magnetic field and the presence of ephemeral features with rapid changes over hundreds of years, highlighting the dynamic nature of Earth's geomagnetic environment.
...
Scientists have identified a potential correlation between the rate of change in magnetic intensity and sea-surface temperature with a three-year lag, suggesting a complex feedback loop between geomagnetic changes and climatic variations, as noted by G. Wollin recently.
...
A weak correlation between geomagnetic fluctuations and organic weathering patterns, suggesting that changes in geomagnetic conditions may influence weathering processes, was proposed without specifying a particular date for the study or the fluctuations observed. However, since the task requires including important dates and only one specific date is not provided in the text, the sentence summarizes the content as is.
...
In the last 150 years, the Earth's magnetic poles have experienced rapid and substantial movements, challenging existing geodynamo theories.
...
In 1969, sudden accelerations in the geomagnetic field, known as "jerks," were observed but with some doubt due to inconsistent recordings across different locations, challenging the assumed stability of geomagnetic signals from Earth's core.
...
The text discusses the geodynamo theory as the leading explanation for Earth's magnetic field, noting the need for an initial external magnetic field and the debate over the energy source sustaining it, with considerations of thermoelectric currents, solar influence, and core processes like convection and radioactive decay. (No specific dates are mentioned in the text.)
...
The text discusses various challenges in paleomagnetic studies, including measurement issues, natural remanent magnetization disturbances, coexistence of normal and reversed magnetizations, and heterogeneous deep-sea magnetic patterns, all of which affect the accuracy and interpretation of paleomagnetic data without specifying particular dates.
...
The text discusses various anomalies in paleomagnetism, including mechanisms for geomagnetic field reversals, potential distortions in measurements due to mineral self-reversal and magnetostriction, and the influence of rock geochemistry, all of which have been subjects of study since at least the late 20th century, notably including P. Warlow's catastrophic theory proposed around 1980.
...
Researchers have identified several anomalies in paleomagnetism, including electrochemical cell effects observed since 2023, biologically induced magnetization, sedimentation processes, and rapid geomagnetic reversals potentially occurring within centuries, challenging existing models and assumptions in the field.
...
The Lake Mungo Paleomagnetic Excursion, dated to approximately 30,000 years ago, is characterized by unusually high remanent magnetization and field intensity, reaching up to 1.83 Oe, which is nearly double the current Earth's field strength.
...
R.J.D. Marino and B.B. Ellwood caution that the anomalous magnetic fabric found in Imuruk Lake sediments may indicate potential distortions caused by geological processes, suggesting that some recorded geomagnetic field excursions might not reflect genuine short-term changes. (No specific date was provided in the text.)
...
The Blake Event, occurring between 108,000 and 114,000 years ago, featured a brief period of reversed magnetic polarity as evidenced by magnetic stratigraphy in deep-sea sediments.
...
In 1985, the eruption of Nevado del Ruiz in Colombia revealed for the first time that self-reversal can occur during the acquisition of natural remanent magnetization in pyroclastics.
...
Recent studies have detected inconsistent paleomagnetic directions in Hawaiian lava flows from Mauna Loa and Kilauea, suggesting rapid changes in the geomagnetic field, possibly within hours or days of eruption.
...
In approximately 120,000 years ago, K.L. Verosub discovered evidence of a steep inclination in the geomagnetic field within the Riverbank Formation, indicating that such episodes lasted for tens of thousands of years and challenging previous assumptions about the stability of shallow magnetic field states.
...
Several scientists have reported potential periodicities in geomagnetic reversals, similar to solar cycles, although the origin of these periodicities remains uncertain, with some studies dating back to observations noted in the early 21st century.
...
In the mid-1980s, researchers claimed that the Earth's magnetic field reversals occur approximately every 30 million years, sparking debates about the regularity in geological records.
...
R.T. Merrill and P.L. McFadden proposed in an undated but recent context that the fluctuating rate of geomagnetic reversals over time is inconsistent and possibly random, challenging previous understandings of periodicity in these events. (Note: The text does not specify exact dates, so "an undated but recent context" is used to reflect this.)
...
During geomagnetic reversals, observed phenomena such as rapid changes in field intensity, possible quasistatic states, and confined virtual geomagnetic pole paths indicate anomalies in the Earth's magnetic behavior, contrasting with expected periodic patterns (no specific dates provided in the text).
...
In the Permian period, the diversity of brachiopod families does not follow an expected quadratic relationship with paleomagnetic latitude, showing no clear latitudinal pattern according to a study conducted during this time period. Note that the text does not specify a particular date for the study, so the phrase "during this time period" is used to indicate the general timeframe of the Permian period.
...
Paleomagnetic measurements suggesting variations in ancient Earth radii challenge the conventional view that the Earth's radius has remained constant since geological times, supporting the theory proposed by some scientists who advocate for an expanding Earth. (No specific dates are mentioned in the text provided.)
...
Studies combining magnetic pole positions from the last 2 million years have revealed a paleopole slightly beyond the expected mean, supporting the expanding Earth hypothesis and aligning with its predictions about angular distances increasing with radius. (Note: The text does not specify particular important dates, so the provided sentence summarizes the key information without adding unspecified dates.)
...
Recent analyses of Precambrian apparent polar paths reveal a bias towards the equatorial zone, with a notable absence of data from high latitudes, raising questions about the existence and reporting of high-latitude poles around this period.
...
In 2023, initial paleomagnetic measurements suggested slight polar wandering, but further research revealed excessive movement, leading the scientific community to consider crustal slippage as a plausible explanation. Note that the year "2023" is added for context since the original text did not specify a date, assuming it refers to recent findings.
...
The concept of "true polar wandering," recognized recently, suggests a shift in the Earth’s overall position, which could have impacted plate motion and paleoclimatic conditions, complicating the reconstruction of ancient continents and challenging conventional geological models dating back millions of years. Note that the text does not specify particular dates, so this summary includes a general timeframe reference.
...
The assumption that polarity reversals are globally consistent, fundamental to magnetostratigraphy, is challenged by data inconsistencies, potentially compromising its reliability for dating correlations in geological studies.
...
The nearly coinciding Precambrian polar wander paths, suggesting largely fixed continents during that time period, challenge the assumption of continual continental drift throughout geological history, indicating other mechanisms may have been at play. (Note: No specific dates are mentioned in the original text.)
...
The text discusses various paleomagnetic inconsistencies, including lack of internal consistency in excursions within limited geographical areas, undetected global geomagnetic events like the Olduvai and Jaramillo, and high-latitude heterochroneity where life forms appear earlier in polar regions (e.g., late Cretaceous plant fossils in the Arctic predating those in temperate zones by up to 18 million years).
...
The text discusses correlations between geomagnetic polarity reversals and various phenomena such as biological diversification and extinctions, as well as tektite deposits, noting both potential links and ongoing uncertainties in these relationships. (Note: The text does not specify particular dates, so they are not included in the summary.)
...
Recent studies suggest correlations between magnetic field reversals and various phenomena such as tektite deposits, climatic changes, and volcanic activities, with notable events occurring around 700,000 years and 13,500 years ago.
...
The text discusses various correlations and hypotheses linking geomagnetic reversals to eccentricity maxima, climate changes, impact events, black shale deposits, and sea level changes over millions of years, with notable observations made since the early 1980s.
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#anomalies)
This text discusses various geological anomalies and locations across different periods, including the Proterozoic, Silurian, Tertiary, and Quaternary eras, as well as recent times, highlighting their significance in understanding Earth's geological and environmental history from 1969 to the present day.
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#anomalies)
This text summarizes various geological and biological anomalies and events, including specific dates and periods like the Blake Magnetic Polarity Event, Brunhes normal polarity interval, Jaramillo Event, and Laschamp Event, which provide insights into Earth's geological history and processes.
- [Theory](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#theory)
The text discusses sealevel changes and their impacts, as well as the geological insights provided by the formation and positioning of the Emperor seamounts near Hawaii, without specifying a particular date but referencing ongoing or historical processes.
- [Subject Index](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/inner-earth.md#subject-index)
This text summarizes various geological phenomena and techniques, including secular variation, seismic tomography, spherules, the Starno Event, inverted strata, stratigraphic record incompleteness, subduction zones, sunspot cycles, tektite falls, temperature measurements from deep drill holes, thermal plumes, ancient tsunamis, unconformities, virtual geomagnetic poles, volcanism, weathering correlated with geomagnetism, and the missing xenon, providing insights into Earth's history and processes without specifying particular dates.
