...
- [ANCIENT INFRASTRUCTURE [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#ancient-infrastructure-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSC3 Tunnel-Well Systems [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msc3-tunnel-well-systems-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSC4 Water Condensers [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msc4-water-condensers-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSC5 Ancient Irrigation Systems [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msc5-ancient-irrigation-systems-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Ancient Agricultural Engineering [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-ancient-agricultural-engineering-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X2. Mesoamerica [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x2-mesoamerica-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X3. Asia [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x3-asia-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X4. Africa [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x4-africa-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Enigmatic Menhirs [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#enigmatic-menhirs-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Four Remarkable Menhirs [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#four-remarkable-menhirs-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Transportation of Very Large Menhirs [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#transportation-of-very-large-menhirs-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Probable Purposes of Menhirs [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#probable-purposes-of-menhirs-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Menhirs in Unexpected Places [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#menhirs-in-unexpected-places-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Er Grah as a Foresight [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#er-grah-as-a-foresight-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Dolmens [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#dolmens-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X1. Dolmens in Asia and Oceania [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x1-dolmens-in-asia-and-oceania-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Jordan [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#jordan-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Northern Caucasus [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#northern-caucasus-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [India [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#india-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X2. Purported dolmens in North America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x2-purported-dolmens-in-north-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSD5 Rocking Stones [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msd5-rocking-stones-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X0. Introduction [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x0-introduction-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X1. Possible origins of rocking stones [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x1-possible-origins-of-rocking-stones-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X2. Distribution of rocking stones [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x2-distribution-of-rocking-stones-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X3. Humans and rocking stones [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x3-humans-and-rocking-stones-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X4. Remarkable rocking stones [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x4-remarkable-rocking-stones-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSE1 Lines of Pits [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mse1-lines-of-pits-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X1. North America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x1-north-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X2. South America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x2-south-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X3. Europe [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x3-europe-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSE2 Puzzling Pits [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mse2-puzzling-pits-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [ANOMALIES [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [The Chronicle of Akakor [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#the-chronicle-of-akakor-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Europe [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#europe-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [France [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#france-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Italy [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#italy-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Middle East [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#middle-east-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Asia [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#asia-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Africa [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#africa-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Oceania [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#oceania-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Oak Island Shaft [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#oak-island-shaft-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Remarkable Ancient Mines and Quarries: A Survey [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#remarkable-ancient-mines-and-quarries-a-survey-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 1: Anomalies in Mining History [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-1-anomalies-in-mining-history-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 2: Notable Discoveries in Early European Mining [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-2-notable-discoveries-in-early-european-mining-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 3: Ancient Mining Practices in Asia [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-3-ancient-mining-practices-in-asia-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 4: Mining Activities in Africa [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-4-mining-activities-in-africa-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSE5 Mines and Quarries [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mse5-mines-and-quarries-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSE6 Lake Superior Copper Mining [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mse6-lake-superior-copper-mining-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Sculpted Hills and Mountains [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#sculpted-hills-and-mountains-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSE8 Terrestrial Zodiacs [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mse8-terrestrial-zodiacs-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X2. Europe [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x2-europe-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X3. Africa [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x3-africa-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomaly Evaluation [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomaly-evaluation-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Similar and Related Phenomena [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#similar-and-related-phenomena-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH3 Double Stone Rows [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh3-double-stone-rows-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH4 Multiple Stone Lines [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh4-multiple-stone-lines-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Stone Arrays and Mazes [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-stone-arrays-and-mazes-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stone Meanders MSHG6 [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stone-meanders-mshg6-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stone Circles MSH7 [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stone-circles-msh7-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH15  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh15--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH16  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh16--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH17  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh17--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH17  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh17--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH19  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh19--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH8  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh8--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH9  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh9--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH10  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh10--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stone-Circle Geometry  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stone-circle-geometry--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Occult Influences on the Design of Stonehenge [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#occult-influences-on-the-design-of-stonehenge-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Physical Phenomena Associated with Stone Circles [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#physical-phenomena-associated-with-stone-circles-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [171 Stonehenge Physical Phenomena [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#171-stonehenge-physical-phenomena-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH13 Psychical Phenomena Concentration at Stone Circles [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh13-psychical-phenomena-concentration-at-stone-circles-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stonehenge Psychical Phenomena [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stonehenge-psychical-phenomena-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stone Circles and the Environment [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stone-circles-and-the-environment-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Large-Scale Organization of Stone Circles [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#large-scale-organization-of-stone-circles-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomaly Evaluation [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomaly-evaluation-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Possible Explanations [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#possible-explanations-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Possible British Leys [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#possible-british-leys-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Possible Leys Outside of Britain and Ireland [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#possible-leys-outside-of-britain-and-ireland-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Critiques of the Ley Concept [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#critiques-of-the-ley-concept-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSH16 Stone Circles Worldwide [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msh16-stone-circles-worldwide-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stone Circles as Eclipse Predictors [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stone-circles-as-eclipse-predictors-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Stonehenge’s Rectangle [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#stonehenges-rectangle-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Did the French Build Stonehenge? [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#did-the-french-build-stonehenge-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Geometrical and Geographical Anomalies of Stone Rectangles [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#geometrical-and-geographical-anomalies-of-stone-rectangles-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [The Old World [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#the-old-world-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Possible Explanations [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#possible-explanations-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [North America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#north-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Vermont [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#vermont-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [New Hampshire [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#new-hampshire-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Massachusetts [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#massachusetts-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Wisconsin [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#wisconsin-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [New Mexico [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#new-mexico-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [South and Central America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#south-and-central-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Honduras [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#honduras-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Argentina [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#argentina-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Peru [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#peru-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Africa [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#africa-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Kenya [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#kenya-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Oceania [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#oceania-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Tonga [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#tonga-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Easter Island [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#easter-island-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Medicine Wheels [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#medicine-wheels-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomaly Evaluation [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomaly-evaluation-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Possible Explanations [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#possible-explanations-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Similar and Related Phenomena [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#similar-and-related-phenomena-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [General Observations [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#general-observations-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [China Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#china-anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Burnt Rock Mounds [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-burnt-rock-mounds-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Fused Forts [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-fused-forts-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Kitchen Middens [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-kitchen-middens-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Conical Piles [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-conical-piles-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Cairn Alignments [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-cairn-alignments-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Submerged Cairns [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-submerged-cairns-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Cairn Complexes [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-cairn-complexes-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Ring Cairns [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-ring-cairns-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Earthen Mounds MSM5 [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#earthen-mounds-msm5-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Mesoamerica [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mesoamerica-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [South America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#south-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Europe [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#europe-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 1: Anomalies of Saint Michel [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-1-anomalies-of-saint-michel-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 2: Asia Minor Burial Mounds [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-2-asia-minor-burial-mounds-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 3: Mounds in China [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-3-mounds-in-china-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 4: Japanese Imperial Graves [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-4-japanese-imperial-graves-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 5: Polynesian Mounds [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-5-polynesian-mounds-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 6: Tonga's Pigeon-Snaring Mounds [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-6-tongas-pigeon-snaring-mounds-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 7: The Giant Grave in the Caroline Islands [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-7-the-giant-grave-in-the-caroline-islands-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chapter 8: Hawaii's Kukii Hill [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chapter-8-hawaiis-kukii-hill-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Mound Lines and Arrays [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mound-lines-and-arrays-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Enigmatic Mound Complexes [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#enigmatic-mound-complexes-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Mound Complexes MSM7  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mound-complexes-msm7--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO4 Curious Arrays and Groupings of Stone or Wooden Columns [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso4-curious-arrays-and-groupings-of-stone-or-wooden-columns-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO5 Latte Stones [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso5-latte-stones-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO6 Delhi Iron Pillar [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso6-delhi-iron-pillar-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO7 New Caledonia Cylinders [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso7-new-caledonia-cylinders-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO8 Unusual Gnomons [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso8-unusual-gnomons-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO9 Stone Chairs [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso9-stone-chairs-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSO10 Large Stone Jars [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mso10-large-stone-jars-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies in Stone Jars and Configured Rocks [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-in-stone-jars-and-configured-rocks-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X0. Introduction [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x0-introduction-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [X1. General observations [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#x1-general-observations-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [The Gateway of the Sun [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#the-gateway-of-the-sun-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSR ANCIENT ROADS AND BRIDGES [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msr-ancient-roads-and-bridges-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Chaco Canyon “Roads”  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#chaco-canyon-roads--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [The Bimini “Road” [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#the-bimini-road-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [The Bimini “Road” [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#the-bimini-road-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Other "Biminis" [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#other-biminis-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [The Maltese “Cart Ruts” [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#the-maltese-cart-ruts-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSR5 Ancient Bridges [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msr5-ancient-bridges-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSW WALLS, EMBANKMENTS, DITCHES [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msw-walls-embankments-ditches-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSW1 Notable Linear Earthworks, a Survey [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msw1-notable-linear-earthworks-a-survey-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Linear Earthworks  [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#linear-earthworks--tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Data Evaluation [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#data-evaluation-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomaly Evaluation [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomaly-evaluation-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Possible Explanations [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#possible-explanations-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Similar and Related Phenomena [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#similar-and-related-phenomena-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [North America [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#north-america-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [New York (Ramapo) [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#new-york-ramapo-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [West Virginia (Mt. Carbon) [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#west-virginia-mt-carbon-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Idaho [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#idaho-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Labrador [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#labrador-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Greenland [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#greenland-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [California [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#california-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Point Reyes [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#point-reyes-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Mesoamerica [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mesoamerica-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Mexico [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#mexico-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSW3 Precision-Fit Stone Walls [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msw3-precision-fit-stone-walls-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSW4 Cyclopean Walls [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msw4-cyclopean-walls-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [MSW5 Deceptive Natural Walls [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#msw5-deceptive-natural-walls-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Deceptive Natural Walls [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#deceptive-natural-walls-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
- [Anomalies [(top)](http://example.com) [(top)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/)](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-infrastructure.md#anomalies-tophttpexamplecom-tophttpsgithubcomsovrynnecdoblobmaster6-literature-mediacorliss-top)
...
- **Anomaly 5: Standing Stone in Poughkeepsie**  
...
- **North Salem dolmen:** One notable structure in North Salem, New York, has a 90-ton round capstone nested upon five support stones, drawing comparisons with genuine dolmens in Ireland. The arrangement may be too precise to have been created by natural forces like melting ice sheets, suggesting possible human intervention.

- **Quista Dolmen:** On Martha's Vineyard, the Quista Dolmen is an unusual structure built from four boulders arranged in a circle topped by a large capstone. Its unusual architecture has led to speculations about its origins, with connections drawn to Native American stone structures.

- **Foxboro "perched stones":** Near Foxboro, Massachusetts, an elliptical arrangement of 14 peculiar "perched stones" is considered suspicious and potentially indicates human involvement, given that similar arrangements are common in northern Europe. Further research into these patterns could illuminate the possibility of a human-designed origin for these dolmen-like structures.
...
- **Difficulty in determining origins**: It is challenging to decide if a rocking stone was placed by natural processes or human intervention. Artifacts that might date or clarify human interaction with these stones are often missing, particularly in North America.

- **Possibility of human involvement**: If it were demonstrated that some North American rocking stones were erected or used by pre-Viking visitors, it would represent an important anomaly. This would suggest a historical connection between Old World cultures and the New World.

- **Debate over natural vs. human origins**: Skeptics argue that most rocking stones are simply the result of natural processes, particularly from glacial action. However, some researchers propose that these stones could have been intentionally destabilized by humans to create a rocking effect.

- **Linear formations as evidence of human action**: The alignment of rocks in lines, such as the Three Breeders in England, presents a stronger argument for human construction rather than a natural occurrence. Their careful spacing lends credence to theories of deliberate placement.

- **Notable positioning of rocking stones**: Many rocking stones are found on elevated terrain, suggesting they may have been purposefully placed there for visibility. One example is Rolling Rock in Massachusetts, known for its strategic and prominent location.

- **Improbability of glacial placement**: Arguments against the natural placement of some stones, like the Peekskill rocking stone, are based on the unlikelihood of such perfect balance being achieved by glaciers alone. The peculiar conditions surrounding its placement raise questions about human influence.

- **Statistical studies lacking**: While the majority of rocking stones might be natural, the absence of robust statistical support to back up claims of natural formation leaves room for doubt. In cases like the Peekskill stone, its circumstances challenge mainstream archeological interpretations.
...
- **Terras Pretas**  
  Found along Brazil's Aripuana River, these unique pits filled with deep black earth range from seven to 17 feet in depth. Scientists believe these fertile pockets, developed by native peoples about 10,000 years ago, were created through unknown methods, particularly contrasting with the contemporary slash-and-burn agriculture.

- **Circular Pits in Peru**  
  In ancient Peru, broad circular pits, some as large as 24 meters in diameter, are associated with several population centers. Although R.W. Keatinge mentions these sunken plazas in his book on Peruvian Prehistory, he does not suggest their purpose.

- **Cole's Pits (Britain)**  
  This cluster of 273 large pits, each over 40 feet in diameter and located in Berkshire, remains an enigma after investigations by D. Barrington. The absence of valuable minerals and the lack of spoil heaps have left their original purpose a mystery.

- **Shallow Pits in Norfolk (Britain)**  
  Extending along eight miles of the North Coast, these shallow pits vary in diameter between six and twenty feet. F.C.J. Spurrell concluded they might be remnants of ancient dwellings but acknowledges their purpose remains uncertain.

- **Excavations in Haute Marne (France)**  
  The pits on the Portland Plateaux were initially thought to be natural formations until H. Norton suggested they might be of human origin. Their depth and intricate interconnections point to a possible connection with ancient flint mines, though this is still debated.

- **Muggenburg Pits (Netherlands)**  
  This site features 57 old pits arranged in a pattern mirroring the Greek zodiac, raising questions about their purpose and the potential for ritualistic use. The alignment of these pits and their distribution indicate an intentional design that contrasts with typical archaeological finds.

- **Gilgai Pits in Iraq**  
  Circular or rectangular depressions found in the Middle East, known as gilgai, are noted for their peculiar alignments and patterns. In northern Iraq, large artificial pits resemble these natural features, though their age, purpose, and the identity of their builders remain unknown.

- **Olduvai Gorge Pits (Tanzania)**  
  Discovered by M.D. Leakey, these ancient pits date back about half a million years and may have been used by early hominids for trapping small animals. The presence of well-preserved fingermarks and a child’s footprint in the sand adds to their intrigue.

- **Stone-Lined Pits in Zimbabwe**  
  Found in clusters on the Inyanga Estate, these numerous large rock-lined pits range from nine to twelve feet deep and 16 to 30 feet in diameter. Despite their impressive size and complexity, no clear purpose for these pits has been established, raising further questions about their origin.
...
In Connecticut, a long stone-lined tunnel was uncovered, leading amateur archaeologists to call it the Montville Souterrain. However, professionals object to this name as it suggests pre-Columbian visitors to the New World, which mainstream archaeologists are reluctant to accept.

- **Ohio Tunnel-Chamber Structure**  
Workmen in Ohio discovered a long tunnel leading to a subterranean chamber in 1981, with local farmers unaware of its existence. The structure, built of sandstone-block masonry, raises questions about its purpose as it seems too damp for storage, resembling the Montville Souterrain in architecture.

- **Indiana Burial Chamber**  
In Indiana, laborers digging a cellar found a stone that dropped into a subterranean room containing four platforms with skeletons and artifacts. The presence of copper tools and the construction methods indicate a level of architectural knowledge not typical of the known Moundbuilders.

- **Mississippi Subterranean Chamber**  
A subterranean chamber was discovered in Mississippi, measuring about 180 feet in length and displaying mason work of equal quality to modern times. The lack of any identifiable Indigenous tradition associated with this structure adds to its mystery.

- **Missouri Valley Subterranean Chambers**  
Over 900 years ago, natives of the Missouri Valley built subterranean chambers accessed by deep shafts, described as unique among North American archaeological records. Artifacts from this mysterious race imply a culture with a significant degree of advancement, potentially linked to Mesoamerican influences.

- **California Auriferous Gravels**  
Gold Rush miners in California found archeological artifacts like the Calaveras Skull deep within auriferous gravels, suggesting they might be millions of years old. This has sparked controversy as creationists argue these findings challenge geological timelines.

- **Teotihuacan Tunnel Under Pyramid**  
At Teotihuacan, an archaeological discovery revealed a tunnel beneath the Pyramid of the Sun that incorporated both natural and man-made elements. The presence of basalt slabs and man-made modifications raises questions about the rituals that likely took place in these chambers.

- **Monte Alban Miniature Tunnels**  
Miniature stone-lined tunnels found at Monte Alban are perplexing as they are too small for normal-sized humans to enter and their purpose remains unclear. Their construction suggests considerable effort and implies they might have served a unique function in ancient rituals or practices.

- **Guatemalan Tunnel System**  
In Guatemala, a large tunnel system was explored, with side passages believed to connect to significant ancient sites, including a pyramid temple. The existence of this extensive network indicates potential complexities in the understanding of pre-Columbian societies' architectural abilities.
...
- **Hangman's Wood Dene Holes**  
  More than fifty dene holes were discovered in Hangman's Wood, Grays, Essex, characterized by shafts that sank into the chalk below. The chambers created from the chalk are intricately designed, but their purpose is still uncertain.

- **Wilsford Shaft**  
  An unusually deep shaft near Stonehenge, larger and more sophisticated than typical dene holes, was excavated but did not lead into chambers. Evidence of Bronze Age tools suggests a complex construction process was utilized, but its purpose remains unknown.
...
- **Qanats in Iran**  
  Iran houses an immense network of ancient water-carrying tunnels known as "qanats," which together measure about 170,000 miles. The scale and complexity of these tunnels reflect advanced engineering from antiquity.
...
- **Unexplained Origins**  
  The shaft is dated to at least 200 years old, with early excavations yielding log platforms and coconut fiber. However, deeper excavation revealed platforms dated much earlier, suggesting more complex historical digging activities that are unexplained.

- **Unusual Materials**  
  Within the pit, excavators found unexpected materials, such as extensive log platforms and remnants of coconut fiber, indicating that whatever was buried held significant value. The logistics of transporting coconut fiber from over 1,500 miles away further deepen the mystery of the site's purpose.

- **Deeper Tunnels Mystery**  
  A lower set of tunnels were discovered, possibly dating back 12,000 years, leading to speculation about different periods of construction. This raises the possibility that what we perceive as one anomaly could actually represent multiple mysteries over time.
...
- **Extreme Age**  
  Some of these mining operations are dated to over 10,000 years, which poses questions about human capabilities and technologies during those times. This challenges traditional narratives of early human activities in mining and metallurgy.

- **Unexpected Target Minerals**  
  The selection of target minerals, such as manganese in ancient Africa, is considered anomalous, suggesting advanced knowledge of mineral resources not typically associated with early cultures. These choices imply the existence of complex societies engaged in extensive trade.

- **Sophisticated Mining Techniques**  
  The evidence of advanced mining techniques in ancient times poses questions about the technological capabilities of early civilizations. This challenges commonly held assumptions about the technological progress of ancient societies.
...
- **Expertly Excavated Prospect Holes in Cherokee County**  
  The "prospect holes" found in Cherokee County, North Carolina, show a level of mining skill that surpasses that typically associated with Native American practices. The expedition responsible for these quarries remains a mystery.

- **Missouri Iron Mine with Prehistoric Mining Evidence**  
  Evidence of prehistoric mining at an iron mine in Missouri uncovered tunnels associated with Native American efforts to extract hematite. This site was possibly a "paint" mine, highlighting a different use for the iron ore.

- **Spanish Diggings in Wyoming**  
  The Spanish Diggings were believed to be excavated by Spanish explorers, yet they were actually created by Native Americans around 2,000 B.C. The chert and quartzite dug from these pits were critical resources for early societies.

- **Flint Hill in South Dakota**  
  Despite its name, Flint Hill was a site for mining quartzite rather than flint, as prehistoric people sought this material for tools. The extensive nature of the mining activities here raises questions about the scale and duration of this effort.

- **Alibates Flint Quarries in Texas**  
  The Alibates Flint Quarries were actively mined by the Clovis people and attracted indigenous groups from various regions for high-quality flint. This site provides evidence of a significant prehistoric mining operation.

- **Hopi Coal Mining in Arizona**  
  The Hopi culture uniquely utilized coal, mining over 100,000 tons from the Jeddito Valley, primarily for fuel. Their methods involved simple extraction techniques that left waste piles characteristic of strip mining.

- **Ancient Tunnels in Utah**  
  In a modern coal mine in Utah, two ancient tunnels were found that are unlikely to have been made by known Native American groups, as no record exists of extensive coal usage among them. This raises intriguing questions about the origins of these tunnels.
...
- **Ancient mines in Zimbabwe**  
  Artifacts from Egyptian and Roman cultures have been discovered in Zimbabwe, suggesting that there was ancient mining activity in the region. This raises questions about the extent of Bantu cultural influences as posited by Gregory due to Semitic trade interactions.

- **Historic diamond mining in southern Africa**  
  Not only was gold mined in ancient South Africa, but diamonds were also part of the cargo shipped to Egypt and neighboring regions. Research by B. Sullivan indicates that diamonds must have been mined vigorously thousands of years ago.

- **Stone-Age artifacts associated with diamond digging**  
  Stone-Age artifacts have consistently surfaced in South Africa's diamond-bearing areas since mining began in 1867. The discovery of these tools caused miners to relocate, as they believed the "Old Ones” had already extracted the diamonds.
...
- **Absence of artifacts from prehistoric miners**  
  The artifacts from the Lake Superior miners do not reflect the estimated production; they are far fewer in number. This raises questions about the identity of these ancient miners and their trade relationships, as much of the artifact collection seems insufficient to account for the copper mined.

- **Unexplained disappearance of copper**  
  The whereabouts of the large quantities of copper removed from Lake Superior remain a significant mystery. Theories range from it being lost or hidden in undiscovered caches to being exported to Old World civilizations for bronze production, but no definitive evidence exists.

- **Technical analysis of copper mining methods**  
  Ancient mining techniques do not seem to have involved complex metallurgy, with indications suggesting that the miners lacked knowledge of smelting. They primarily used crude tools and methods to extract copper, primarily for cold-working rather than metal casting.
...
- **Kenko (Peru)**: Kenko presents an array of bizarre carvings including steps, tunnels, and unusual features that appear ancient yet are not documented in mainstream archaeology. The structures seem to have been violently displaced, suggesting they might have survived a significant earthquake long ago.

- **Marcahuasi (Peru)**: Located near Marcapomacocha, Marcahuasi features rocks that resemble humans and animals, creating a blurry line between natural formations and shaped sculptures. The area has been popularized by fringe archaeology, and its strange features raise questions about their origins and cultural significance.

- **Petra (Jordan)**: Unlike the other sites, Petra is a well-documented site where the Nabateans carved elaborate structures out of solid rock. This remarkable achievement does not challenge existing paradigms, but it does include instances where entire mountain tops were transformed into buildings.
...
- **Anomaly 2**: The orientation of each bear is consistent with Indian legend. This cultural connection indicates that the design may reflect traditional narratives rather than arbitrary choices.

- **Anomaly 3**: The path of the bear effigies corresponds with the summer path of Ursa Major. This correlation further supports the idea that these structures may have been created with astronomical knowledge.

- **Anomaly 4**: The direction of the nearby Bird Effigies aligns with the orientation of Cygnus relative to Ursa Major. This relationship suggests a careful planning in positioning these effigies to reflect celestial motions.

- **Anomaly 5**: The distance between the bird mounds and the bear mounds signifies a correlation with the appearance of Cygnus when Ursa Major is at its lowest point. This suggests a thoughtful integration of astronomical events into the site's layout.
...
- **Anomaly 2**: The River Cary is noted to outline a lion’s shape, which is unexpected and significant. This resemblance raises questions about human influence on natural features in structuring a zodiac.

- **Anomaly 3**: Maltwood's conclusions on the zodiac's existence suggest a possible mix of natural and manmade elements forming a coherent image. This merging of nature and human effort challenges conventional views of terrestrial zodiacs.

- **Anomaly 4**: The purported features of the Glastonbury Zodiac bear similarity to questionable sculpted rocks in Peru. This resemblance adds to doubts regarding the intentionality behind the designs.

- **Anomaly 5**: Some land configurations in Somerset allegedly correspond to zodiac signs, as outlined by Maltwood. However, the lack of precise celestial alignment complicates these claims and raises questions about their validity.

- **Anomaly 6**: The visible shapes in Somerset’s roads do not match conventional arrangements of constellations. This discrepancy undercuts the argument for a coherent zodiac representation.
...
- **Anomaly 2**: The offset appearance of the star Mintaka compared to the pyramids raises questions about the site plan's precision. This detail suggests either a remarkable foresight by ancient builders or mere coincidence.

- **Anomaly 3**: Bauval's hypothesis implies the pyramids serve as a terrestrial representation of a well-known constellation. This suggests a sophisticated understanding of astronomy among ancient Egyptian architects.
...
- **Stone Rows Associated with Native Games**
  Certain long stone rows in Greenland are linked to traditional native games, altering their perceived purpose from ritualistic to recreational. This association demonstrates that not all stone rows were necessarily built for sacred or ceremonial functions.
...
- **Avenues and Double Stone Rows**
  Avenues and double stone rows are often seen together and might serve as ceremonial pathways. Their design and arrangements reflect the ritualistic behavior of the societies that constructed them.

- **Multiple Stone Rows (Fans)**
  These rows present a more complex arrangement of stones and offer unique perspectives on ancient societal functions. Their composition leads researchers to inquiries about local rituals and cultural significance.

- **Meandering Stone Rows**
  Meandering stone rows illustrate variability in the layout of megalithic structures. Their paths might suggest specific cultural meanings related to journey or pilgrimage.
...
- **Menec's Jog**: Menec, a site of interest for potential astronomical applications, jogs slightly to the north midstream. This deviation suggests that something more than astronomical considerations may have influenced its design and layout.

- **Large Enclosures at Menec**: Menec features large enclosures at both ends, yet these structures have no apparent astronomical significance. This observation supports the argument that the multiple stone rows were likely constructed for ritual practices rather than astronomical mapping.

- **Neglected Research on Arrays**: There is a notable lack of comprehensive data regarding stone arrays and mazes, particularly those outside of Western Europe. The absence of critical information, such as dates and dimensions, calls into question the validity of current conclusions about these structures.

- **Ambiguous Purpose of Stone Mazes**: The purposes behind many stone mazes, particularly those found in the American Southwest, remain largely elusive. This mystery, combined with the extensive megalithic activity in Algeria and India, complicates the archeological narrative surrounding these sites.

- **Irregular Appearance of Ashdown Stone Rows**: The Ashdown stone rows show a chaotic spread of stones, some lying flat and others on their edges, making it difficult to ascertain their original arrangement. This disarray prompts further speculation about their intended function and historical significance.

- **Tourist Attraction Theories in Sweden**: The stone mazes in Sweden, while known for their intricate design, appear to have transitioned into tourist attractions over time. Some believe they may have originally been constructed for recreational purposes, complicating the understanding of their historical use.

- **Subterranean Labyrinths in Russia**: The existence of "subterranean labyrinths" in Russia, primarily known through anecdotal evidence, poses intriguing yet unverified claims about their origin and purpose. Local legends suggest these structures have significant cultural reverence, yet their specific functions remain largely unknown.

- **Topock Maze's Ceremonial Use**: The Topock Maze, located near the Colorado River, is thought to have been used ceremonially by local Indigenous populations for ritualistic purposes. The theories surrounding its design and cultural implications reflect a blend of archaeological inquiry and Native American history.

- **New Mexico Stone Arrays Similar to European Styles**: The stone array discovered in New Mexico shares similarities with famous structures found in Britain and Brittany. Its unusual presence in North America raises questions about cultural diffusion and the potential influences of ancient practices across continents. 

- **Inaccessible Ancient Circular Maze**: A massive circular maze located in Arizona remains largely inaccessible, raising questions about its construction and intended use by prehistoric peoples. Its intricate design challenges prevailing notions of the capabilities of ancient civilizations and their engineering methods.

- **Geometric Precision in Indian Megaliths**: In southern Hyderabad, the megalithic structures display striking geometric precision, raising questions about their purpose and the cultural significance behind their alignment. The lack of clear historical context for these structures complicates their interpretation within the broader narrative of ancient Indian societies. 
...
- **Data Evaluation**: Most stone meanders likely served similar purposes as mazes, such as ritual walks or spirit paths. However, uncertainty remains regarding their exact purpose and the nature of their designs, which has led to a moderate anomaly rating.

- **California - Panamint Valley**: This valley is recognized for potentially containing the largest number of uninterrupted rock alignments in the world. Ancient peoples started constructing meanders at least 8,000 years ago, much earlier than many European counterparts, suggesting significant cultural practices associated with these formations.
...
- **Flattened Circles**  
  A total of 150 stone circles exhibit peculiar flattening, deviating from the near-perfect form. These flattened circles required special construction techniques, as opposed to the simpler methods used for making nearly perfect circles.

- **Ellipses**  
  Out of the stone circles analyzed, 100 are classified as ellipses. Similar to nearly perfect circles, the construction of ellipses is relatively straightforward but still demonstrates a level of geometrical sophistication.

- **Egg-Shaped Circles**  
  There are 50 egg-shaped stone circles recorded, which signify another deviation from the expected circular form. The specific construction techniques for these egg-shaped designs suggest additional knowledge of geometry beyond mere circle-building.
...
- **Magnetic phenomena**  
  There is an absence of conclusive evidence that humans can consciously sense geomagnetic fields, leaving magnetometer surveys as the only objective method for investigation. A survey around the Rollright Stones revealed fluctuating magnetic intensities, suggesting patterns that New Agers claim indicate intentional ancient placement of stones based on magnetic properties.

- **Radioactivity phenomena**  
  The lack of a human "radioactivity sense" makes the presence of anomalous radioactivity at stone circles particularly perplexing. Geiger-counter surveys around the Rollright Stones revealed localized hot spots with readings that were approximately double the background levels, suggesting unexplained anomalies in radiation.

- **Ultrasound phenomena**  
  Following serendipitous discoveries during the recording of bats, Dragon Project members identified unusual ultrasound signals nearby stone circles at dawn. These signals appeared regularly, particularly peaking during equinoxes, but a definitive source for the ultrasound remains elusive.
...
- **Types of Dowsing Lines**  
  G. Underwood identified three types of invisible lines that could be detected around stone circles: "water lines," "track lines," and "aquastats." Each type represents varying strengths of underground influences, pointing to the complexity of the earth's energetic landscape beneath these sites.

- **Convergence of Lines**  
  The convergence of all three types of lines at stone circles signifies the presence of blind springs that dowsers have struggled to understand. This convergence might imply that ancient builders were intentionally selecting sites based on these invisible energy fields.

- **Discrepancies in Dowsing Maps**  
  Dowsers often create underground maps that differ significantly in the placement of lines. This inconsistency raises questions about the nature of these energies and suggests that the patterns detected by different practitioners are not universally reproducible.
...
- **Springs and Stone-Circle Siting**  
  The correlation between stone circles and the presence of springs is acknowledged but lacks substantial empirical research. Historical references imply a tradition of positioning sacred sites over underground water sources, indicating an understanding of the spiritual significance of water in ancient cultures.

- **Noncorrelation of Stonehenge's Location and Stone Sources**  
  It is noteworthy that Stonehenge is positioned far from the sources of its construction stones, a fact that presents questions about the intentions behind its siting. The transport of stones over large distances hints at significant social organization and a cultural connection to the sites’ geographic settings.

- **Integration with Topography**  
  Recent analyses suggest that Stonehenge was deliberately situated to maintain visibility from various other megalithic structures in the landscape. This strategic placement perhaps underscores a complex network of ritual sites within the larger ceremonial landscape of the region.

- **Stone-Circle Siting and Thunderstorm Frequency**  
  Most British stone circles are notably located in areas with low thunderstorm activity, a geographical pattern that may hold cultural significance. This correlation raises questions regarding the environmental preferences of ancient builders and the potential influence of weather patterns on their site selection.
...
- **Boscawen-un Complex**: The stone circle Boscawen-un features an unusual arrangement with a notably tilted central pillar and seven spoke-like leys that supposedly extend outward. This complex challenges definitions of leys due to its peculiar structure and the mystery of its design rationale.
...
- **Bolivian Line Tracks**: In western Bolivia, long straight tracks accompanied by cairns and shrines mimic the ley concept, but these do not include stone circles. These lines bear resemblance to Watkins' vision of leys, presenting a slim chance of validating his theories outside Britain.
...
- **Europe outside of Britain and Ireland**
  Stone circles from the Neolithic and Bronze Ages are recognized in several European countries, sometimes resembling those in Britain. In Italy, a 30-foot-diameter stone circle may reflect British influence, while Romania's circles had calendrical applications with small stones.

- **Sweden**
  Ale's Stones in Sweden, shaped like a ship and used as a giant calendar, challenge traditional views of the site's age. Some scientists suggest they are far older than previously thought, indicating unexpected cultural or astronomical significance.

- **Spain**
  Unique stone circles in the Basque region are notable for their size and layout using a base-7 counting system instead of a decimal system. Some of these circles, dating from recent centuries, are intriguing for their unusual configuration and cultural implications.

- **India**
  A discordant double circle on Bilgiri hills in India presents an anomaly, as it lacks traces of interments commonly associated with such circles. The size and arrangement of stones are atypical and suggest a purpose that remains unclear.

- **Japan**
  Spectacular complex stone circles in Japan incorporate sun-dial constructions, which are positioned identically in both sets of circles. Their astronomical significance potentially indicates a sophisticated understanding of celestial movements.

- **North America**
  Questions around the origins of ancient stone circles in North America often arise when their discoverers consider transoceanic diffusion versus independent invention. Sites such as New England show possible astronomical alignments, but their purposes remain elusive and contested.

- **Michigan**
  A large stone circle on Beaver Island suggests possible astronomical alignments and may have been constructed by ancient sun worshippers. Experts theorize that the unique structure serves calendrical purposes, highlighting its cultural significance.

- **Iowa**
  Stone circles identified in Iowa raised questions among archaeologists, contrasting with popular beliefs that they were solely for practical uses like anchoring tents. Noteworthy observations include configurations suggesting ceremonial contexts distinct from typical utility.
...
- **Sleeping Circles, California**: Thousands of so-called "sleeping circles" are found in southern California, mostly circular but sometimes in ellipses or rectangles. Attributed to the San Dieguito culture, these circles, only a few inches in diameter, potentially date back thousands of years.

- **Stone Circle, Santa Cruz Mountains**: A 15-meter diameter stone circle in the Santa Cruz Mountains shows two stones aligned with the meridian, marking the direction of sunrise at the winter solstice. Its exact age is unspecified, though the area is now forested.

- **Cairns and Stone Circles, British Columbia**: Groups of ancient cairns and stone circles ranging from 3 to 13 feet in diameter were noted on Vancouver Island. Local Indians referred to them as belonging to the "old people," with suggestions that they may be remnants of ancient dwellings.

- **Stone Circle, Quebec**: T.L. Lee's report from 1966 highlighted a notable stone circle with a remarkable arrangement of stone blocks in Ungava Bay. The circle is distinguished by its uniformity in size and a larger central block, hinting at complex cultural significance.

- **Stone Circus, Haiti**: R. Schomburgk described a massive stone circle in Haiti, which consists of two concentric rows of flat river-polished stones forming a continuous ring. The structure includes a unique central stone and features that suggest it cannot be attributed to the indigenous peoples encountered by Columbus.

- **Stone Circles, Peru**: The rare stone circles in South America, primarily located at Sillustani, may have escaped travelers' notices. Noted for their resemblance to other monuments, these circles are attributed to the Quicha name meaning "where the sun is tied up."

- **Megalithic Circles, Gambia and Senegal**: West Africa hosts stone circles and menhirs that intrigue visitors with their megalithic nature. The circles are typically burial sites, with excavation findings indicating a likely construction period between 900 and 1000 A.D.

- **Stone Circle, Libya**: During the early 1930s, R.A. Bagnold found a stone circle in Libya made of sandstone slabs; it stands 27 feet in diameter. However, this site lacked artifacts or any noted astronomical alignments.

- **Nabta Playa Circle, Egypt**: A small stone circle in the Nabta Playa depression has been identified with significant astronomical alignment, possibly existing well before many megalithic structures in Europe. The age aligns closely with the onset of hyper-aridity around 4,800 years ago.

- **Rujum Al-Hiri, Israel**: This site features five giant rings acting as a multi-purpose astronomical tool, predating Stonehenge by approximately a thousand years. The larger stones are remarkably substantial, indicating a sophisticated construction.

- **Yemen Circular Site**: A circular Bronze-Age religious site in Yemen consists of granite pillars weighing about 20 tons. The specifics regarding whether this site aligns with the category of stone circles discussed remain unclear.

- **Megalithic Pillars, Arabia**: Reports describe numerous stone pillars in Arabia, with only a vague reference to a "gigantic circle" featuring enormous upright stones. The precise context and details of this structure remain largely unknown.
...
- **Anomaly 2**: If Stonehenge functioned as an eclipse predictor, it would indicate an intellectual sophistication far beyond what is typically associated with Neolithic societies. Critics argue that the lack of written records and the relatively short lifespan of the builders would make such advanced usage unlikely. 

- **Anomaly 3**: The complex structure of Stonehenge, with its many components, has led to the proposal of various other interpretations of its purpose. This multitude of possible designs undermines the singular theory that it was exclusively an eclipse predictor. 

- **Anomaly 4**: Technical objections have been raised regarding the eclipse-prediction hypothesis, such as the lack of true alignment between the eclipse cycles and possible inaccuracies in Hawkins' measurements and claims. Over the centuries, shifts in stones and changes in the landscape may have further complicated interpretations of the site. 
...
- **Isolation of Knowledge Among Tribes**: Despite inquiries made by Simms to the Crow tribe regarding the "medicine wheel," none had visited it, and their knowledge was limited to hearsay. This isolation raises questions about the communication and preservation of tribal knowledge across generations.

- **Variations in Design and Function**: Each medicine wheel exhibits distinct features in its design, such as the number of spokes and structural complexity. This variation implies that different cultures or groups utilized the wheels for diverse purposes, challenging the idea of a singular use or meaning.

- **Disparity in Geographical Distribution**: The concentration of medicine wheels in Canada and their absence or rarity in certain regions suggest significant cultural or environmental factors influencing their creation. The great distances between known sites further complicate assumptions about shared cultural practices or builders.

- **Geometric and Astronomical Alignments**: The geometric similarities noted between certain North American medicine wheels and European stone structures raised questions about potential cultural diffusion. Astronomical alignments identified by researchers like Eddy indicate these structures may have served not just spiritual but also practical purposes related to timekeeping and navigation.

- **Cultural Absence in Modern Times**: Current Indigenous populations exhibit little awareness or connection to the historical significance of the medicine wheels, leading to speculation about their original cultural uses. Anthropologists must rely on legends and fragmented knowledge to reconstruct possible meanings, which may be influenced by time and the passage of traditions.
...
- **Wooden Structures in New World**  
The woodhenge at the American Cahokia site in Illinois was almost certainly devoted to astronomy, but it was basically a calendar site and not sophisticated enough to call anomalous. The great temporal gulf separating the Old World and New World woodhenges essentially bars any suspicions of trans-Atlantic influences. 
...
- **Enormous shell mound at San Pablo**  
The shell mound at San Pablo was nearly a mile long, half a mile wide, and over 20 feet thick, indicative of significant cultural practices by local indigenous groups. Additionally, Indian skeletons and mummies, buried within the mound, demonstrate complex burial customs and social structures.

- **Massive shell deposits in the Aleutians**  
The Aleutians feature expansive shell deposits layered with mammalian bones, signifying a long period of accumulation over approximately 3,000 years. These findings highlight the interaction of marine and terrestrial ecosystems, and reveal insights into the Diets of past inhabitants.

- **Sambaquis along the coast of Brazil**  
Sambaquis, meaning "shell mountains," are complex mounds from which archeologists have recovered not only shells but also fish bones and human burials. At the Jabuticabeira-II site, a staggering 43,800 human burials emphasize the scale and significance of these structures in ancient Brazilian cultures.

- **Large sambaquis reaching heights of 60 feet**  
Studies reported by G. von Koenigswald revealed sambaquis that soared to exceptional heights, far exceeding typical structures of the time. This remarkable construction indicates advanced engineering skills and the cultural importance placed on these burial sites.

- **Shell Keys of Florida**  
The Shell Keys off Florida's southwestern coast are artificial islets predominantly composed of shells and include intricate features like walls and canals. Their complexity is likened to the Moundbuilder structures, suggesting advanced engineering capabilities of prehistoric cultures.

- **Curious Cairns of unusual characteristics**  
Cairns described in this collection boast unusual sizes and arrangements, making them worthy of investigation. Despite many serving practical purposes, some remain enigmatic, raising questions about their origin and function.

- **Extremely large cairns in New England**  
Cairns in New England's Indian cemeteries reach significant heights, with some measuring over 15 feet tall. The scale suggests a societal importance or ceremonial function, distinguishing them from the simple trail markers often attributed to cairn constructions.

- **The Great Stone Mound of Ohio**  
Ohio's Great Stone Mound, reported to be up to 50 feet high, faced significant destruction during the 19th century, yet remains a notable structure. Its impressive dimensions and the limited discoveries made during its dismantling challenge our understanding of the region's prehistoric inhabitants.

- **Alleged 200-foot-high cairn near Fort Laramie**  
A striking claim regarding a cairn near Fort Laramie suggests it rises 200 feet, which, if accurate, would be unprecedented. However, skepticism remains about these dimensions, indicating a potential for exaggeration or misinterpretation of its true size. 

- **Knocknarea cairn in Ireland**  
The cairn atop Knocknarea near Sligo, Ireland, is 35 feet high and 200 feet in diameter, believed to cover ancient tombs. Its impressive size and the surrounding legends add an air of mystery to its purpose and construction.

- **Barnenez cairn in Brittany**  
Barnenez in Brittany is an immense and complex cairn with burial chambers, showcasing a significant mixture of architectural styles akin to ziggurats. Its terraced design and unusual configuration challenge conventional categorization, emphasizing its historical importance.

- **Effigy cairns in North America**  
Effigy cairns found in Wisconsin depict animals and objects on a grand scale, often constructed with meticulous planning. While rare in North America, their existence suggests deeply rooted cultural expressions among indigenous populations.

- **Conical and pillar cairns in New England**  
These cairns, meticulously constructed from selected stones, showcase unique architectural features that differentiate them from other cairn types. Their age and purpose are unclear, raising intriguing questions about the societies that built them.
...
- **Complex of cairns near Ellenville, New York**: This site contains around 300 cairns, some displaying careful craftsmanship that qualifies them as conical cairns. The sheer number and arrangement of these stone piles suggest a significant cultural or ritual significance.
...
- **Monks Mound**  
Monks Mound is the largest earthen mound in North America, but recent drilling revealed a layer of stone beneath its surface, challenging previous beliefs about the construction materials used. This raises important questions about the methods and intentions of the Cahokia culture.

- **Akapana**  
The Akapana is a pyramidal hill at Tiahuanaco, uniquely aligned with the cardinal points, and features mysterious water works and a significant stone basin at its summit. Archaeologists continue to unravel the purpose behind this impressive structure, believed to have involved significant labor and engineering.
...
- **Cholula**  
Cholula is a massive human-built structure distinguished by its volume, yet it remains primarily an earthen mound rather than a stone pyramid. Hidden within its depths are extensive tunnels, suggesting a blend of pagan and Christian influences sustained through centuries.
...
- **Watson Brake Discovery**  
  Watson Brake undoubtedly predates Poverty Point by about 1,900 years, presenting an early and puzzling mound complex. Its mounds date back to 3,000-3,400 B.C. and were built by a culture that remains largely mysterious, raising questions about their origins and purpose.

- **Construction Efforts**  
  The monumental effort required to create the mounds in both Poverty Point and Watson Brake contradicts the idea that they were built by mobile hunter-gatherers, highlighting an inconsistency in our understanding of these ancient societies. Despite the labor involved, no burials have been found at these sites, leaving their purposes unclear.
...
- **Portsmouth Works (Ohio)**
  - The Portsmouth Works complex is thought to mirror celestial bodies, aiming to capture the heavens in its design. This extraordinary claim was made by Stansbury Hagar, suggesting that the earthworks represent the sun, moon, stars, and even elements of ancient lunar worship.
...
- **Cam-Wedging of Temporary Shafts**  
  A method involving a shaft with a triangular cross-section could be twisted into place, creating a tightly wedged anchoring point. While this aligns with mooring theories and standardized hole dimensions, it does not require Viking involvement.

- **Cavities Left by Weathered-Out Crystals**  
  Weathering of large crystals from rocks like granite can produce geometrically shaped holes. However, the uniform size of these cavities and the improbability of all tourmaline crystals being oriented in the same direction raises questions about their natural formation.

- **Costa Rican Stone Spheres**  
  The existence of hundreds of granite spheres in southwestern Costa Rica, some up to 8 feet in diameter, presents questions regarding their origin and purpose. Despite professional archaeology investigations, the lack of stone-working tools and geological sources of granite fuels ongoing speculation about their manufacturing.

- **Lack of Knowledge About Sphere's Purpose**  
  Key inquiries regarding who manufactured the spheres, when they were crafted, and how they achieved their precision remain unanswered. Their purpose, in particular, remains a mystery, prompting wild speculation and various hypotheses.

- **Natural Geological Processes**  
  Several natural geological processes can create stone spheres, although the perfect sphericity of the Costa Rican spheres challenges this explanation. This phenomenon contributes to the larger discourse on the methods of their creation and possible functions.
...
- **Artificiality and Early Human Contact**  
  If the cylinders are indeed artificial and the radiocarbon dates are accurate, this could indicate that humans reached New Caledonia several millennia before the established historical timeline. Additionally, this discovery could imply that the use of cement predates its known use in the Mediterranean by thousands of years.
...
- **Celebes Stone Jars**: Following an exploration in Celebes, large stone jars similar to those in Laos were described, often found with large stone statues. The local populations claim ignorance regarding their origins, and the contents of these jars provide no clues about their purpose.

- **India Stone Jars**: Explorers in northeastern India discovered large stone jars in the North Cachar Hills in 1929, with a few resembling those found in Laos and Celebes. Most of these jars were simply cavities in unworked boulders, indicating a potential variation in craftsmanship and purpose.

- **Easter Island Pits**: Curiously carved pits, over 5 feet deep and 34 feet in diameter, were found on Easter Island, likened to vat-like structures. Despite no stone jars reported from Easter Island, these peculiar pits contribute to the discourse regarding cultural diffusion or independent invention.

- **Configured Rocks in Peru**: Sayhuiti features an imposing Great Monolith, possibly a scale model of an unknown area with intricately carved structures, animals, and figures. Its association with lost cities adds to the intrigue surrounding its purpose, which remains elusive.

- **Concacha's Bizarre Carvings**: Located near Abancay, the carved rock at Concacha has incongruous features and channels suggesting practical or ritualistic use, though their exact significance is still debated. The chaotic nature of its carvings stands out in stark contrast to more defined structures elsewhere.

- **Sierra de Santa Marta in Colombia**: An enormous rock with convoluted carvings reminiscent of brain coral presents another anomaly, adding to the collection of configured rocks that perplex researchers. Its irregular form raises questions about the intentions and capabilities of the cultures that produced such artworks.
...
## MSR1 Ancient Roads
- **Macadam Method:** A portion of a macadamized road discovered in Virginia suggests advanced road construction techniques by an ancient, unknown population. The discovery includes a well-graded stone bed, indicative of a sophisticated understanding of road engineering before the advent of European technologies.
...
- **Coba Region Sacbeob**: In the Coba region, a network of sacbeob is present, illustrating an advanced understanding of road construction by the Maya. Despite lacking wheeled vehicles, they left behind a significant stone cylinder near one sacbe, indicating their knowledge of the wheel principle.

- **Von Brackel's Highways**: Baron von Brackel documented ancient highways in western Michoacan, constructed from large stones and adeptly designed to manage water runoff. The highways' construction was robust, with many miles still in excellent condition, raising questions about their intended use.

- **Inca Road Network**: The Inca incorporated and expanded existing pre-Inca roads, creating a vast network that far exceeded the Roman road system in scale. Their engineering achievements included overcoming geographical challenges related to rivers and high mountains, which were not present in Roman engineering.

- **Wide Pre-Inca Highways**: Savoy's observation of an unusually wide pre-Inca road in Peru generated curiosity about why earlier cultures required such expansive pathways. In contrast, the Inca managed their extensive network with narrower roads, suggesting different needs or traffic patterns.

- **Ancient Trackways in Britain**: The presence of ancient "trackways" in southern Britain indicates extensive use of these paths well before Roman influence. These trackways, often transformed into modern roads, demonstrate an early understanding of road construction akin to later developments.

- **Sweet Track Discovery**: The Sweet Track, one of the oldest known man-made structures in Europe, is a wooden trackway built almost 6,000 years ago in Britain. Its existence raises questions about the technological capabilities of Neolithic peoples, particularly related to navigating swampy terrain.

- **Diolkos Railway**: The Diolkos served as a unique railway system for ships in ancient Greece, showcasing an innovative approach to transportation by linking two bodies of water via a paved path with grooves for trolleys. This engineering marvel eliminated lengthy maritime detours, reflecting advanced maritime logistics.

- **Mauryan Road in India**: The ancient Mauryan road in India, purportedly over 2,600 miles long, illustrates the extent of road construction efforts prior to significant historical periods. Its impressive length signifies the sophisticated governance and organizational capabilities of the Mauryan rulers.

- **Egypt's Paved Roads**: The Egyptians pioneered paved road construction to transport heavy stone blocks from quarries to building sites, indicating advanced engineering and logistical planning. The estimated width of their roads and the innovation of using rollers for transportation emphasize their engineering achievements.

- **Evidence in the Rift Valley**: References to ancient roads and irrigation works in the Rift Valley highlight a previously unrecognized level of civilization in East Africa. Capt. G.E.H. Wilson's findings suggest a network of communication that predates known historical periods, prompting further archaeological interest. 
...
- **Lack of Unification**: Despite the extensive investment in the road system, the lack of unity is perplexing. Some roads seemingly terminate without purpose, leading to questions about the overall design and intent behind their construction.

- **Over-engineered and Under-used**: The roads have been described as "over-engineered and under-used," indicating a significant allocation of resources for a system that may not have served a practical daily purpose. This suggests that their creation coincided with periods of social or ceremonial significance rather than pressing survival needs.
...
- **Regularity of the Underwater Stones**: Critics, asserting that the stones are merely beachrock, argue that the perfect alignment of these stones is improbable if formed naturally. They suggest a slant in the subsurface terrain as necessary for the stones' positioning, yet this is contradicted by the flat nature of the seafloor.

- **Bend in the Road**: A significant feature noted by anomaly investigator D.G. Richards is a 90° bend in the formation of the "Road," which is atypical for natural beachrock. This unusual geometric characteristic raises questions about the origins of the formation, hinting at potential human intervention.

- **Parallel Rows of Stones**: Another observation by Richards highlights the presence of parallel rows of stones, which he finds inconsistent with natural beachrock formations. The arrangement is viewed as anomalous and suggests a level of intent in their placement that contradicts the theory of natural formation.

- **Regularly Spaced Piles of Stones**: Observed feature D consists of regularly spaced piles of stones extending over 13 miles, cutting across ancient beach lines. This pattern is suspicious in its regularity and spatial distribution, leading to suggestions that it is not purely a product of natural processes.
...
- **Venezuelan Trenches**  
  Trench systems in the Rio Negro region of Venezuela were discovered to have an average length of about 300 feet, differing significantly from those in Tikal. Initially thought to be defensive structures, archeological evidence suggests they might have been used to conceal canoes instead.

- **British Dykes**  
  In Britain, linear embankments known as dykes were constructed, characterized by their parallel trenches. These defensive structures, created during the Iron Age, have been largely obscured by agricultural practices over the millennia.

- **Offa's Dyke**  
  Offa's Dyke, built between 757 and 796, is the largest single earthwork in Britain, running 150 miles. Despite its size, it seems impractical to defend, as militarily it would have required more troops than were available at that time.

- **Cursuses**  
  The term cursus refers to linear earthworks that consist of two long, parallel embankments with ditches on the outside, used for processional activities. The true purpose of these structures remains enigmatic, particularly their association with burial rites.

- **Kadangas in India**  
  The kadangas in southern India resemble British earthworks and are of unknown antiquity, with some sections believed to have been repaired historically. These massive earthworks range to heights of 30 feet and traverse significant distances.

- **Bigo Earthworks in Uganda**  
  Imposing earthworks in the Bigo region of Uganda feature deep trenches—some cut into solid rock—showcasing the impressive capabilities of their creators. The depths of these ditches, sometimes reaching 12 feet, indicate advanced construction techniques for their time. 
...
- **Chimu's "Great Wall of Peru"**  
  The true extent of the Chimu's Great Wall was not realized until the 1931 Shippee-Johnson Aerial Photographic Expedition discovered it. Stretching from the Santa River delta for perhaps as far as 50 miles inland, this ambitious structure required significant labor to construct.

- **Second Great Wall in Nepena Valley**  
  Discovered by explorer G. Savoy in the late 1950s, this wall originated near the coast and coursed inland then narrowed to a single wall. Remarkably, this wall had been overlooked by many archaeologists despite its presence in an area of prior excavation.

- **Inca's "Great Wall of the Incas"**  
  This structure is one of the longest stone walls in South America, estimated to be about 150 miles in length. While poorly investigated, it reportedly runs along high ridges at altitudes of 8,000-12,000 feet, slowing down advancing forces despite its modest height.

- **Shebib's Wall in Jordan**  
  Documented by A. Kirkbride in the 1940s, this wall stretches about 20 miles with no clear purpose, indicating its function as a boundary line rather than a military installation. Its sheer size and structure suggest significant effort went into its construction, indicating serious disputes over ownership.
...
- **Vinapu stonework**: The Vinapu ahu is noted for its intricate assembly of irregularly shaped stones, closely resembling grand Incan constructions. However, the superficial similarity does not hold when considering the techniques and structural integrity of the materials, which show marked differences from the building methods used in Cuzco.
...
- **Rockwall, Texas**: The peculiar rock formation in Rockwall resembles an artificial wall, leading local residents to speculate about its origins. Geologists class this structure as a naturally occurring sandstone dike, dismissing notions of an ancient human civilization and highlighting the need for scientific rigor in such claims.
...
- **Investigator Findings**: B. Brailsford and D.H. Childress analyzed the wall's stones, concluding they were cut and fitted with an unusual precision. However, Brailsford noted that a cavity behind the front face indicated a possible natural formation.

- **Comparison with Natural Formations**: Geologist P. Wood found the wall to be a natural feature formed by typical cooling processes in ignimbrite, dismissing the idea of human craftsmanship. The jointing of the stones resembled the hexagonal prisms commonly found in basalt flows, further implying a geological rather than anthropological explanation. 
...
- **MSH16-R10**: This reference likely pertains to a specific text or publication dealing with ancient societies or artifacts. It suggests research or analysis that uncovers unusual patterns or technologies from past civilizations.

- **MSO5-R1**: This anomaly signifies an occurrence within a specific scope of ancient studies, pointing to a document or finding of significance. The nature of this reference is indicative of a deeper societal or scientific exploration of historical events and their implications.

- **MSD2-R3**: Denotes a possible reference that could illuminate aspects of a study involving ancient tools or engineering practices. The anomaly might focus on methodologies or craftmanship that exemplified ingenuity in early societies.

- **MSM3-R5**: This anomaly connects to literature focusing on unknown aspects of what was once deemed improbable or impossible in ancient construction or societal organization. The citation potentially illustrates prehistoric achievements that challenge current understanding.

- **MSH11-R1**: Represents a mention in a scholarly article examining the intersection of mythology and documented history. This anomaly could provide insights into ancient narratives that defy conventional archeological beliefs.

- **MSR4-R3**: Suggests a record or finding that highlights anomalies within burial practices or rites among ancient cultures. This anomaly may provoke inquiries into intended meanings behind historical burial traditions.

- **MSR1-R25**: This anomaly references may pertain to ancient civilizations' use of celestial navigation or other astronomical insights. It indicates a connection to the architectural or societal frameworks borrowed from celestial observations.

- **MSM5-R35**: Refers to an investigation possibly related to artifacts that have puzzled historians in terms of their origin or utility. This anomaly invites further exploration into items that do not fit neatly into established historical timelines.

- **MSH2-R11**: This entry suggests a situational analysis of human habitation patterns that diverged from what was expected. It could denotate a foundational study linked to sociocultural constructs or environmental adaptations.
...
- **Akapana Mound**  
  The Akapana Mound in Bolivia has mystified researchers due to its unique construction and historical significance. Its purpose remains a subject of debate among archaeologists and historians alike.

- **El Mollar Calendar Site**  
  The El Mollar site in Argentina presents anomalies with its calendar-like structures believed to have been built by indigenous peoples. Archaeologists are perplexed by the precision of its astronomical alignments.

- **Bimini Road**  
  The Bimini Road, located in the Bahamas, is a submerged rock formation that many speculate to be part of an ancient civilization's road. Its existence provokes discussions about Atlantis and other lost civilizations.

- **Hohokam Canals**  
  The Hohokam people of Arizona created an extensive canal system that continues to astound modern engineers. Many anomalies exist regarding their methods and the reasons for their sophisticated irrigation network.

- **Orongo Site**  
  The Orongo site on Easter Island features unique stone structures linked to the island's ceremonial practices. Anomalies arise regarding the significance of these structures and their connections to the island’s famous moai statues.

- **Nazca Lines**  
  The Nazca Lines in Peru consist of massive geoglyphs etched into the desert floor, the purpose of which is still unclear. Some theories suggest they were used for astronomical purposes, but no definitive explanations exist.

- **Ogam Inscriptions**  
  Ogam inscriptions found on ancient stones in Ireland and other regions form a peculiar writing system that has intrigued linguists. The meaning and origins of these inscriptions still spark debates among scholars.

- **Delphi Pillar**  
  The Delphi Pillar in Greece carries significant historical importance as a marker within the ancient sanctuary of Delphi. Its exact purpose and how it fit into the larger religious practices of the time remain ambiguous.
...
- **Quarries**: Quarries are locations from which stone or other materials are extracted. The presence of such sites often indicates significant historical or geological significance.

- **Cairn Complexes**: Cairn complexes are stone constructions often used as burial sites or ceremonial markers. Their configurations can reveal information about cultural practices and land use of ancient peoples.

- **Rocking Stones**: These are large rocks that can rock or pivot on a base. Their unique positioning often suggests they may have been intentionally placed for ceremonial or navigational purposes.

- **Physical Phenomena**: This anomaly refers to various unexplained natural occurrences within specific geological contexts. The study of such phenomena may provide insight into environmental conditions and geological processes.

- **Radiation Levels**: Anomalies in radiation levels can indicate the presence of specific mineral deposits or other geological formations. Continuous monitoring can reveal patterns that may correlate with historical usage or natural disasters.

- **Magnetic Anomalies**: Variations in Earth's magnetic field can suggest the presence of iron-rich mineral deposits. Such anomalies can also impact navigation and have been the subject of exploration in archaeological contexts.

- **Integration with Other Sites**: This anomaly explores how certain geological features relate to adjacent historical or archaeological structures. Understanding these relationships can enhance the knowledge of cultural interactions and land utilization in ancient times.

- **Integration with Topography**: This anomaly assesses how specific locations interact with surrounding geographical features. The landscape's layout often influences settlement patterns and resource allocation, reflecting on past human activities.

- **Occult Influence**: This term refers to the speculative connections between certain sites and mystical practices. While contentious, examining such beliefs can shed light on cultural significance and historical context.

- **Relation to Geological Faults**: Analyzing how anomalies correspond with geological faults can provide information about tectonic activities and earth movements. This understanding is crucial for risk management in areas prone to earthquakes.

- **Shafts**: The presence of shafts may indicate mining operations or ancient burial rituals. Their construction often reveals engineering techniques and societal organization.

- **Standing Stones**: This anomaly highlights the use of upright stones as markers or memorials, often imbued with cultural significance. Their alignment and placement can indicate astronomical events or rituals.

- **Rock Lake Pyramids**: These structures, often referring to underwater formations, may signal intentional creation for ritualistic or cultural purposes. Their discovery changes the understanding of ancient civilizations' adaptability and ingenuity.

- **Tunnels**: The existence of tunnels can denote advanced engineering and social complexity of the civilizations that built them. They often serve as passageways or storage areas, revealing patterns of transportation and resource management.

- **Earthquake Effects**: This anomaly assesses how seismic activity can reshape landscapes and impact human structures. Understanding these effects is vital for assessing historical vulnerabilities and preparedness for future events. 

- **Trenches**: Trench formations can signify military operations or ancient construction efforts. The analysis of these structures can reveal strategic thinking and territorial defense mechanisms of past societies.
