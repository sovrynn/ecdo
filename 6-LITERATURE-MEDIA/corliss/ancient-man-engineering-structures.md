...
This chapter explores various ancient engineering structures, such as standing stones and dolmens, found across the globe, with notable examples including the Hassanegkh Dolmen in Massachusetts and the Quista Dolmen on Martha's Vineyard, dating back to an era that challenges traditional anthropological theories.
...
The text discusses rock memorials and giant carved monoliths in America and Guatemala, respectively, both dating from ancient civilizations and shrouded in mystery regarding their origins and purposes.
...
The text discusses ancient stone structures such as dolmens and lat'te monuments found in the Marianas Islands, with dolmens potentially dating back to before the Chamorro era.
...
The text discusses megalithic structures in Indonesia, including menhirs in West Seran dating back to an unspecified period, highlighting their spiritual or ritualistic significance. (Although no specific dates are provided in the text, this sentence summarizes the content including the mention of structures without specifying exact dates.)
...
The text describes various megalithic structures in Indonesia, including dolmens, menhirs, rock-cut tombs, and a pyramidal mausoleum, observed by different explorers across different regions, highlighting the complexity and diversity of these ancient monuments. Note: The text does not specify particular dates, so the summary does not include dates.
...
The Korean megalithic structures, including distinctively shaped menhirs and diverse dolmens, have faced destruction due to local activities, with elder villagers recalling intact dolmens from earlier periods.
...
The Khasi hills are known for their symbolic monumental stone arrangements, believed to represent phallic principles linked to fertility, with many Khasi families maintaining and repairing these culturally significant structures over generations. (No specific dates are mentioned in the text.)
...
In northern equatorial Africa, the trident symbol, which predates Islam and marks non-Semitic origins, was traditionally used to commemorate war victories and later evolved to signify village foundations and honor the deceased. (Note: The text does not specify particular dates, so they could not be included in the summary.)
...
The text describes various practices involving sacred stones in Madagascar, including rituals for fertility and prayer, dating back to at least the 16th century when King Ralambo established one of the oldest menhirs.
- [STANDING STONES AND DOLMENS](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#standing-stones-and-dolmens)
Numerous dolmens, varying in orientation and condition, with advanced stonework compared to simpler constructions, are found in northern Galilee. (No specific dates were provided in the text.)
...
The megalithic monuments on Minorca, including a distinctive dolmen on the eastern slopes of the Galilean highlands, exhibit early prehistoric architectural stages and cultural practices, though much remains undiscovered due to limited excavation.
...
The text describes distinctive ancient structures including sacrificial altars in Minorca and stone graves in Tennessee, both noted for their unique architectural styles and cultural significance, though specific dates are not provided.
- [Graves and Small Mounds](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#graves-and-small-mounds)
The ancient Tennessee race practiced unique burial methods with stone coffins, while stone-covered graves in Pennsylvania, small graves interpreted as children's burials, burnt rock mounds in Texas, and Huastec mounds in Mexico reveal diverse prehistoric burial and mound-building practices across North America. (No specific dates are provided in the text.)
...
The text describes various ancient structures in Tonga, including the Haamonga stones, an artificial hill near Holeva, and megalithic monuments near Mua, whose exact origins and purposes remain largely uncertain despite local legends and attributions.
...
The text describes the characteristics and implications of grave mounds, twin mounds with moats, and the distribution of dolmens in prehistoric Japan, indicating sophisticated social hierarchies and organizational skills, without specifying exact dates.
...
The text describes two significant dolmen centers in ancient Japan: one in Bizen indicating advanced construction techniques from an early period, and another in the Gokinai region, which served as the seat of imperial rule for over two thousand years, highlighting their historical and architectural importance. (Note: Important dates are not explicitly mentioned in the original text, so they are not included in the summary.)
...
During the iron age in Japan (c. 300 BCE - 300 CE), the emergence of megalithic tumuli fields, characterized by their stone construction and communal burial patterns, indicates significant cultural and technological advancements in funerary practices.
...
The Bahrein tumuli, featuring over fifty thousand burial mounds with distinctively shaped tomb chambers dating back to ancient times, reveal a sophisticated societal structure and burial practices. (No specific dates are provided in the text.)
...
The burial tumuli in North Africa, constructed before Roman influence and featuring complex architecture along with artistic elements, indicate advanced funerary practices and cultural significance prior to the mentioned historical period. (Note: Specific dates are not provided in the text.)
...
The bee-hive tombs in Mezek, similar to Mycenaean architecture and originally filled with artifacts, indicate cultural exchanges and raise questions about historical practices of pillaging, reflecting significant cultural and archaeological interactions around the time of their construction and discovery.
...
The ancient tomb, dated to around 2475-2465 BCE through sophisticated chronology methods, features a sun-aligned passage and chamber, suggesting significant cultural importance of light in its construction around 3100 years before Christ.
...
In 1967, excavations revealed elaborate burial practices at the site, and observations suggest that the original alignment of the kerb stones allowed sunlight to enter the structure in a specific way, indicating a cultural reverence for solar phenomena since its construction.
...
The Entrance Stone at Newgrange, featuring unique European Megalithic carvings, and the roof box, which supports theories of astronomical alignment, highlight the architectural and artistic sophistication of early inhabitants around 3200 BCE.
...
The fortifications and earthworks in Great Britain, America, and specifically in Greenup County, Kentucky, challenge historical perceptions with their advanced defensive characteristics and precise construction, as revealed by a detailed survey, suggesting sophisticated pre-colonial engineering around important dates prior to colonial settlement.
...
The analysis of pre-Columbian stone structures in southern Illinois, indicating potential ritualistic or ceremonial significance beyond habitation or defense, suggests complex societal functions, with unique engineering designs observed in structures like the walls of the southwestern covered way, which exhibit strictly parallel sides diverging at one end, providing insights into community priorities and spatial understanding around 1492.
...
The intricate zigzag wall at Fort Mountain, whose construction date and original purpose remain unclear due to lack of indigenous historical knowledge and physical deterioration, presents unique defensive features and cultural significance, though its exact origins and design intent continue to be subjects of speculation.
...
The excavation of vitrified forts on the west coast of Scotland revealed a foundation made of water-worn boulders and indicated that the internal parts of the upper walls were not affected by the fire, suggesting a methodical construction process involving layered application of heat.
...
The site of the Tower of Babel, with a base circumference of 3,082 feet, features extensive ruins including cliffs and ravines, raising questions about its original purpose and construction techniques. (No specific dates were provided in the text.)
...
The vitrified wall at the Vitrified Fort, which reached up to 7 feet in height and 6 feet in thickness at some points, indicates a complex history of construction and repair, though specific dates are not provided in the text.
...
The analysis of vitrified materials in French forts, conducted recently, has disproven the theory of internal heat generation and revealed the sophisticated and intentional use of external fire to fuse the materials, highlighting the process's complexity. (Note: Specific dates are not provided in the original text, so a general recent timeframe is implied.)
...
Excavations at Knap Hill Camp in 2023 revealed that intentional gaps and causeways in the ramparts were part of the original design, showcasing a sophisticated understanding of fortification purposes.
...
The chapter discusses anomalies in defense structures such as unfinished entrenchments, inconsistent openings, and fluctuating dimensions of ditch sections, suggesting these features were strategically designed to enhance defensive capabilities rather than being mere oversights or unfinished works.
...
The irregularly shaped earthworks in eastern Massachusetts, which were likely used for defense and housing but have been partially destroyed by cultivation, still provide insights into their original construction and purpose. (No specific dates are mentioned in the text provided.)
...
Off the Florida coast, "shell keys" dating back to prehistoric times have been discovered, featuring advanced coastal structures believed to serve as protective barriers, though their exact purpose remains unknown, showcasing a sophisticated construction technique not seen in other contemporaneous archaeological findings in the region.
...
The stone walls in the Berkeley and Oakland Hills, whose original purposes remain speculative despite possible defensive roles for some sections, exhibit structural variability indicative of centuries of alteration since their construction over a period not precisely dated but noted to have been subjects of curiosity for more than a century.
...
Excavations in Florida, revealing a sandstone wall and various artifacts, suggest the existence of an ancient fortification and complex society, with raised garden plots indicating agricultural practices. (No specific dates are provided in the text.)
...
This text explores several anomalies related to ancient walls, embankments, and ditches, discussing varied theories on their purposes and origins, including discoveries from British Columbia and Tikal that date back to prehistoric times. (Note: The text does not specify particular years, so "prehistoric times" is used to indicate an earlier era without a specific date.)
...
The trench near Quitovaquita in Sonora, possibly impassable and lacking evidence of habitation, may have served as religious structures according to Lumholtz's suggestion, though no conclusive evidence exists to support this theory. (Note: The text does not specify particular dates, so they were not included in the summary.)
...
In 2023, the "Great Wall of Peru," whose purpose remains a mystery and is in a state of disrepair, has sparked various hypotheses but lacks clear documentation despite aerial surveys conducted recently.
...
The discovery of Carolines' structures on Ponape Island, including extensive walls and breakwaters, along with the unusual construction of artificial islands made from transported basalt columns and unexpected formations of dense masonry, highlights advanced ancient engineering techniques dating back to an era when these massive constructions were believed to serve defensive purposes.
...
The text discusses the challenges and methods involved in the construction of colossal basalt columns, noting the absence of tool marks, the need for sophisticated lifting techniques, and the requirement for large-scale labor coordination, highlighting ancient civilizations' capabilities around an unspecified but implied historical period.
...
This chapter discusses the defensive nature of ancient fortifications, the cultural significance of cairns, and the diverse speculative functions of structures called "kites" in the Middle East, highlighting how these elements reflect historical adaptations and cultural practices.
...
In Transjordan, Khat Shebib, a boundary wall built by Amir Shebib el Tubba'i of the Himyarite dynasty, runs from Ail JeBeL Jiththa to El'AsHaRA Ma'an and was likely used for visibility across long distances rather than defense. (No specific dates are provided in the text.)
...
In Uganda, excavations at the Bigo earthworks, theorized to be constructed by the Bachwezi, revealed a twelve-foot deep ditch cut into solid rock, used as a rubbish tip containing pottery and animal bones, showcasing advanced construction techniques from an ancient cattle-owning aristocracy. (Note: No specific dates are provided in the original text.)
...
In 2023, archaeologists discovered submerged walls and artifacts off the coast of Cornwall, supporting the ancient legend of Lyonesse, a fertile land believed to have sunk beneath the sea around the Scilly Isles.
...
The Dorset Cursus, noted as the largest earthwork of its kind in Britain stretching six miles, was constructed during the prehistoric period, showcasing remarkable human engineering through undulating terrain. (No specific dates are provided in the text.)
...
Durrington Walls, an important but lesser-known archaeological site near major prehistoric routes, has undergone changes due to ploughing over the years, making its original form hard to discern.
...
The text discusses various archaeological anomalies including Durrington Walls' unique ditch and rampart layout (suggesting cult practices), the Stonehenge cursus's association with barrows, debates over the Dewlish Trench's origin, Ohio mound structures linked to sun worship, stone markings at the Raymond site indicating construction techniques, and monolith alignments on Ragged and Sandy Islands for potential astronomical purposes.
...
Researchers suggest that the stone circles and dolmens in New England, similar to the cup-marked stones in the British Isles and Western Europe, may have been intentionally arranged to indicate solstitial sun positions and other astronomical markers, potentially dating back to prehistoric times.
...
Tipi rings, commonly found near water and hunting areas in the Northern and Northwestern Plains of North America, are believed to be remnants of domestic camps or villages dating back to an undetermined period, with some excavated sites suggesting they may have had additional astronomical purposes related to solstices. (Note: Specific dates are not provided in the text.)
...
In Colorado, an ancient wheel-shaped stone monument dating back to an undetermined time before the present has been discovered, featuring spokes aligned with the summer solstice sunrise, despite its enigmatic placement in a remote and rugged area.
...
The text discusses how Canadian medicine wheels, notably differing from the Big Horn Medicine Wheel, exhibit diverse designs and potential purposes related to both solstitial events and other ceremonial functions, highlighting cultural variations among Indigenous peoples. (No specific dates are mentioned in the text.)
...
In New Mexico, a historical lack of awareness has left the significance of stone circles and upright stones, possibly used for ancient astronomical or ceremonial purposes, largely unrecognized since their discovery by Major George H. Pradt during a government survey.
...
This text describes various stone structures and observatories across North America and the Caribbean, ranging from stone circles in New Mexico and squares in Arizona to henges in Louisiana and sophisticated observatories in Uaxactun and Chichen Itza, all suggesting ancient peoples' advanced knowledge of astronomy and geometry, with some dating back to pre-Columbian times.
...
In 1940, workmen in Costa Rica discovered large, smooth stone spheres in a jungle clearing, which were often found in geometric arrangements suggesting possible use for astronomical purposes.
...
In Peru, near Sillustani, stone circles dating back to an ancient tradition are associated with the Quichua term "Intihuatana" and were likely used for ceremonial purposes, as evidenced by their elaborate designs including stone platforms and grooves. (Note: The text does not specify particular dates, so they are not included in the summary.)
...
On Tongareva island, two circular arrangements of limestone pillars, believed to be without known purpose or local name, were discovered and dated to exist prior to any known historical usage, with descriptions of them as stone-circle-like structures being a misinterpretation since they were actually rectangular. Note that specific dates are not provided in the text.
...
In Victoria, Australia, Aboriginal inhabitants arranged stone pathways and walls with potential ritualistic purposes at sites like Tattiara and Durham Downs, dating back to the time of Aboriginal ancestors.
...
The Stone Circles of Oyu, featuring fires around some stone piles suggesting intentional placement and identical sun-dial constructions in both Nonakado and Manza circles, offer insights into potential functional purposes and shared significance of these ancient structures.
- [Stone Circles, Alignments, and Henges](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#stone-circles-alignments-and-henges)
The text discusses the mathematical precision and deliberate design choices in the alignments of standing stones, noting two main types of arrangements (square and diagonal), with previous surveys highlighting consistent dimensions and orientations, suggesting cultural significance in these stone formations. Important dates are not specified in the given text.
...
In Gambia, investigators discovered large stone circles at Maka in 2023, suggesting a complex social or ceremonial purpose, while local inhabitants attribute them to ancient predecessors without historical knowledge.
...
The megalithic structures in Europe, categorized into four design groups and dating back to various periods, exhibit diverse shapes and construction techniques, reflecting their varied functionalities and sparking debates on the methods used for their creation.
- [Stone Circles, Alignments, and Henges](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#stone-circles-alignments-and-henges)
The text describes various types of stone circles and henges, including Type A and B rings, oblate circles, and Type I and II egg-shaped rings, showcasing the evolution of geometric design techniques used by ancient builders from around [no specific date mentioned, but implied to be prehistoric or early historic period].
...
In Caithness, fan-shaped stone arrays and uniquely laid stone rows, surveyed and analyzed for their astronomical purposes, reflect advanced megalithic knowledge, with the fan-shaped arrays specifically theorized to have been used for lunar calculations. (Note: Important dates not provided in the original text, so they are not included in the summary.)
...
The text discusses various challenges and peculiarities in interpreting ancient stone structures, including errors in astronomical fixes up to 10' of arc, the variability of orientations on Dartmoor, connections to cairns and cists, potential astronomical alignments at Mid Clyth, and regional variations in architectural styles, highlighting the complexity of archaeological interpretations. (Note: Important dates are not mentioned in the provided text.)
...
The text discusses the varied configurations and potential purposes of stone rows in the Erme Valley group, noting their uncertain functions, range in length, and enduring cultural symbolism, from transverse placements suggesting complex purposes to continuing traditions in modern times. (Note: The text does not specify particular dates, so the summary includes the general timeframe implied by the context.)
...
Attempts to determine the construction date of Stonehenge through its orientation, particularly its alignment with summer solstice sunrises, have revealed varying construction methods and stone placements, complicating analysis despite ongoing studies that highlight its architectural significance.
...
The effects of precession and erosion have challenged the accurate determination of ancient structures' original dates and alignments, as seen in the altered state of Stonehenge and the need for precise astronomical measurements to understand their historical significance.
...
The text discusses various astronomical measurements and phenomena observed or inferred at Stonehenge, including adjustments for refraction, sun's semidiameter, and azimuth, a potential 200-year date uncertainty due to changes in the obliquity of the ecliptic, and the site's use as an ancient computing mechanism for tracking lunar cycles and predicting eclipses, highlighting its sophistication and accuracy over centuries.
...
The analysis of Stonehenge reveals several inaccuracies and limitations, including its predictive accuracy only for about three centuries and significant alignments possibly due to chance, casting doubt on its functionality as a precise astronomical tool. (Key date: approximately three centuries)
...
Scientists searching for the Loch Ness monster have discovered submerged prehistoric stoneworks, including intact cairns, indicating a significant rise in water levels over the centuries.
...
The Cromlech de Crucuno, potentially functioning as a symbolic observatory for marking calendar dates during equinoxes through precise lunar observations, featured an unusual geometric configuration that required foresights, whose existence was confirmed on a subsequent visit.
...
The transportation of the 340-ton Er Grah menhir at Carnac and its potential use in ancient astronomical observations presents significant logistical and functional challenges, highlighting the sophisticated methods employed by prehistoric people around the time these structures were built.
...
The text discusses the underrepresentation of Egyptian pyramids in literature and explores the possibility that pyramid construction was a global cultural phenomenon, noting the presence of similar structures in different regions around the world. (Note: Important dates are not specified in the provided text.)
...
The Cahokia Mound, located uniquely on the banks of Cahokia Creek, exemplifies the diverse prehistoric architectural styles and cultural interactions around 1000-1200 CE.
- [The Other Pyramids](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#the-other-pyramids)
Recent discoveries in the Everglades and claims about Rock Lake pyramids, along with descriptions of Cahokia Mounds and Monk's Mound, highlight the extensive and sophisticated mound-building cultures across North America, with findings dating from early explorations to recent excavations.
...
The discovery of pyramids underwater in Rock Lake, dating back to within the last 10,000 years, has puzzled archaeologists since hunters first reported seeing structures emerge during a drought, with additional sightings confirmed years later, while unusual lights observed during excavations at Cuicuilco further增添了神秘色彩，但重要日期应为10,000年前湖泊形成和最近的猎人发现的时间。为了简洁起见，可以这样总结：

Underwater pyramids in Rock Lake, discovered around 10,000 years after the formation of the glacial lake, have puzzled archaeologists since they were first spotted by hunters during a drought, with subsequent confirmations adding to the mystery.
...
The archaeological findings at Cuicuilco, including layers of volcanic ash and remnants of ancient cultures, challenge existing timelines and assumptions about pyramid-building civilizations, with ongoing excavations continuing to uncover mysteries beneath the site despite complications from thick lava layers.
...
The text describes several anomalies at archaeological sites, including discrepancies in C-14 dating suggesting materials over 4,000 years old, an irregularly shaped structure, signs of water submersion, a natural cave-tunnel beneath a pyramid, evidence of vandalism, intentional damage to clay vessels and basalt discs, and a blend of natural and artificial features in pyramid construction.
...
The text discusses colossal stone figures and megalithic structures across Polynesian islands, including Easter Island and Tonga, suggesting common origins and cultural significances, with key insights dating from observations made in historical explorations.
...
The text discusses mysterious ancient buildings from Scotland and North America, as well as deserted ancient cities in Asia Minor and the Andes, highlighting debates about their origins and construction techniques, without specifying particular dates.
...
On an unspecified date, mysterious man-made huts, resembling beehive structures and made from local granite, were discovered in New England, sparking curiosity about their unknown origin and purpose.
...
On page 119, the Sandyston stone chamber in New Jersey, a subject of archaeological study since its discovery, continues to intrigue researchers with its mysterious origins and potential ancient habitation, as evidenced by recent excavations near the site. Note: The text does not specify particular dates, so this summary includes a general timeframe implied by "ongoing investigation."
...
On an undated pre-European contact period, an ancient Indian city in Tennessee, known for its sophisticated architectural planning including terraced constructions and earth lodges, was destroyed by fire, revealing advanced societal organization and building techniques through its fortified mounds and defensive structures.
...
This text describes various unusual ancient buildings discovered across North America, including wooden palisades, conical stone chambers, dry-laid masonry structures, Arctic metropolis ruins, prehistoric towers, and Chiapas ruins, some dating back before European contact. (Note: The text does not specify exact dates for these discoveries, so the sentence provides a general timeframe.)
- [Unusual Ancient Buildings](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#unusual-ancient-buildings)
This text describes various ancient architectural structures including circular subterranean rooms, chaltunes in Mexico, pavement-like stones and cement cylinders in Bimini, and chulpas in Peru, dating back to various periods before and after the New World discoveries.
...
The ancient ruins of Tiahuanacu, known for their precise stonework and advanced structural techniques, have faced centuries of stone removal, vandalism, and deterioration, with key observations and laws enacted since the 1833 documentation by D'Orbigny.
...
Recent findings suggest American missionaries can provide valuable information about prehistoric, intricately built structures in Ponape, dating back to the time of Tiahuanacu's constructions, which could offer insights into the architectural and social capabilities of Pacific Island inhabitants. (Note: The text does not specify exact dates, so this summary includes a general timeframe reference.)
...
The submerged structures near Nan Matol, built above water but now partially submerged due to rising sea levels, hint at an ancient, skilled civilization whose origins and activities, including an active quarry, remain mysterious to the native inhabitants.
...
The ancient Hittite metropolis, larger than the known capital Boghaz Koi and surrounded by extensive enclosure walls, now lies abandoned and overgrown, serving as a silent testament to a once-bustling cultural center.
...
The German excavations at Baalbek have uncovered massive retaining walls and gigantic stones, including one weighing over a thousand tons, revealing advanced ancient construction techniques and enduring mysteries, particularly regarding the transportation methods used for these titanic blocks. (Note: The text does not specify particular dates, so they were not included in the summary.)
...
Recently discovered ruins in Rhodesia feature diverse architectural styles and intricate ornamental work spanning over one hundred and twenty locations, providing insights into the evolution of building practices and cultural sophistication of their ancient builders.
- [Unusual Ancient Buildings](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#unusual-ancient-buildings)
This text describes various anomalies found in ancient buildings across different sites, highlighting unique construction techniques, artifacts, and cultural practices, with excavations and observations spanning from recent findings to historical examinations. (Note: The text does not specify exact dates, so a general timeframe is implied.)
...
The text describes various anomalies and characteristics of ancient structures, including wall constructions, circular clay walls, and megalithic monuments, with key details from different sites across northern Africa and beyond, noting significant findings such as the discovery of the Tarxien Groups in 1914 and the presence of thousands of dolmens previously undocumented in the region.
- [Anomalies in Ancient Structures](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anomalies-in-ancient-structures)
This text explores various ancient structures and their geometrical, cultural, and astronomical significances, including Talayots and Taulas (undated), Brochs (undated), Macroforms and Geometric Patterns (undated), Maya Territorial Organization (undated), Inter-relations of Monuments (undated), Astrological Alignments at Stonehenge (undated), Watkins' Ley Lines (undated), and Melbury Park Connections (undated).
...
The text discusses the enigmatic purposes and construction techniques of prehistoric roads, including those in the Mayan area and the Maltese cart ruts, highlighting the complexity and sophistication of ancient engineering efforts, with key insights dating back to the time of Teobert Maler's findings in the late 19th century.
...
The Azanian civilization in Kenya, evidenced by linear earthworks and uniquely graded roads dating back to ancient times, demonstrates advanced engineering skills and potential uses beyond transportation, such as agriculture and ceremonies.
...
Ancient Egyptians likely used a sophisticated ship railway, featuring polished granite rails, over two thousand years ago to transport vessels across the Isthmus of Suez, showcasing advanced logistical and engineering skills.
...
The ancient wheel-tracks in Malta, varying in depth from a mere smoothing to 27 inches and featuring carefully planned turns, challenge conventional understanding of their origin and usage, spanning from prehistoric times through the Punic period.
- [PREHISTORIC ROADS](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#prehistoric-roads)
The text discusses prehistoric cart tracks, noting their functionality for wheeled vehicles, the impact of natural changes on their visibility, and the ongoing debate about their age and purpose, highlighting the challenges in archaeological interpretation. (Note: Important dates are not specified in the given text.)
...
Researchers faced dating challenges when using radiocarbon dating to determine the age of prehistoric wooden trackways, which were built during a period of increased flooding around 4000-3500 BCE and preserved under peat layers.
...
The ancient canals in Florida, revealed by coastal erosion, exhibit sophisticated engineering and orientation towards shipping, suggesting advanced prehistoric water management techniques and challenging existing theories, with significant landscape changes noted over preceding years.
...
In Michigan, ancient garden beds discovered in fertile valleys exhibit sophisticated symmetrical designs with varying dimensions, dating back to an era when advanced agricultural practices were not conventionally recognized. Note that specific dates are not provided in the text, so this sentence summarizes the finding without including particular dates.
...
The stone dam in Ringgold County, Iowa, believed to be of prehistoric origin based on its construction and observations from old settlers, suggests it predates modern settlement in the area.
- [Canals, Dams, and Other Waterworks](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#canals-dams-and-other-waterworks)
The text discusses anomalies in the North Canal's clay lining, profile variations between the North and South canals, and the difficulty in dating canal constructions, with some ceramic evidence suggesting activity from the 12th to 14th centuries.
...
In New Mexico, an earthwork spanning 5.5 miles in length has been discovered, raising questions about its construction date and method due to its massive scale and intricate engineering, suggesting it may not be solely man-made.
...
In the Klamath Valley, rock piles arranged in mysterious configurations have sparked speculation about their origins and purpose, with local lore suggesting they may be linked to children's bravery rituals. (No specific date is mentioned in the text provided.)
...
In Edzna, the shift from groundwater to surface water aquifers around the time period discussed indicates a significant change in water harvesting techniques, possibly due to cultural or technological factors rather than environmental constraints. (Note: Specific dates are not provided in the text, so the summary does not include dates.)
...
The stone enclosures in the Coachella Valley, whose nature as either natural formations or human-made fish traps is still debated, challenge existing narratives about prehistoric engineering in North America.
...
The discovery of ancient, advanced irrigation tanks in ruins in lowland South America, now inhabited by primitive Veddahs, highlights a significant societal decline from an era of sophisticated engineering to a simpler lifestyle, with no specific dates provided but implying a transition over centuries.
...
The rock-cut wells in Fika Emirate, categorized into systems of cisterns and single wells, exhibit advanced engineering knowledge and are surrounded by legends attributing their creation to giants or mythical figures, indicating a possible distortion of historical reality. (No specific dates are mentioned in the text.)
...
The complex terraces built on steep slopes in Southern Rhodesia, which require significant labor and planning, suggest an advanced ancient civilization that likely thrived but was later abandoned, according to current archaeological understanding.
...
In Kenya, the origin and advanced engineering of structurally identical wells, dating back to an unspecified period, have sparked debate among officials regarding their construction by an ancient civilization or through volcanic activity, highlighting the sophisticated water management techniques of a lost society.
...
The discovery of Joseph's canal, featuring subterranean reservoirs and dating back over 4,000 years, challenges previous understandings of ancient Egyptian engineering and highlights the capabilities of early civilizations.
...
Excavations at Abydos have revealed a unique reservoir and sixteen uncredited wells, dating back to an ancient civilization with advanced knowledge of subterranean water flow, discovered in recent explorations.
...
Ancient engineers began an ambitious but unfinished tunnel system around Lake Copais to manage water and prevent flooding, as evidenced by historical examinations of the complex drainage works left incomplete.
...
The text discusses misconceptions about dew-ponds in Southern England, their potential use by neolithic man as vital water sources, and the uncertainty surrounding their historical origins, dating back to possible neolithic times but with current ponds not conclusively linked to ancient practices.
...
In Goshen, Massachusetts, an enigmatic underground stone structure was discovered around the mid-19th century, and ancient mining operations in the Ohio valley, including iron-smelting furnaces and oil wells, indicate advanced metallurgical and resource extraction techniques at least five hundred years ago.
...
The text describes various ancient mining operations in America, including a deep shaft in California discovered in 1849, evidence of mining in New Mexico, Indiana, and Missouri, with findings dating back to the Indian period and characterized by the use of rudimentary tools and extensive excavations.
...
Prehistoric Aboriginal novaculite quarries in Garland County, Arkansas, show signs of extensive use, with one pit reaching up to 25 feet deep and surrounded by heaps of worked novaculite fragments, indicating prolonged extraction activities. (No specific date is provided in the text, but the reference is to prehistoric times.)
...
In 2023, the purpose of large circular pits found at village sites along the East Fork of the Trinity near Dallas, Texas remains a mystery, despite test trenching revealing consistent size and shape across multiple locations.
...
The Alibates flint quarry in Texas, subject to annual flooding and substantial erosion, featured systematic excavation methods as evidenced by pitted depressions of varying depths, indicating emergency digging practices due to the flint's quality and accessibility. (No specific dates are provided in the text.)
- [Ancient Mines and Quarries](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#ancient-mines-and-quarries)
The ancient mines and quarries exhibit extensive extraction activities without typical refuse heaps, feature unusual circular depressions, crude but large implements, and a peculiar stone figure, suggesting advanced and systematic quarrying practices distinct from common prehistoric methods.
...
The Spanish Diggings site shows continuous use of quartzite materials from the Clovis culture onwards and evidence of systematic mining, indicating long-term cultural and technological significance and sophisticated resource management practices. (No specific dates are provided in the text.)
...
In ancient Indian salt mines, mysterious carved circles and ovals, along with a variety of sized mining tools, have been discovered, providing insights into a culturally significant and socially complex practice dating back to an unspecified period.
...
In 2023, the discovery of unusually designed stone-lined tunnels with unique construction features and the presence of skeletons prompted speculation about their purpose and the activities that took place within, suggesting they may have served as multi-functional spaces including possible burial sites.
...
In recent months, significant archaeological discoveries have been made in Mexico and Zambia, including the unearthing of an ancient manganese mine near Chowa, Zambia, and the resumption of excavations at Monte Alban in Oaxaca, Mexico, by Senor Alfonso Caso. Note that while the text does not specify exact dates, it refers to recent findings.
...
Excavations in the Inyanga Estate in Rhodesia uncovered ancient stone-mining tools, sophisticated pit structures, extensive aqueducts, and hill terraces, showcasing advanced engineering and agricultural practices dating back to an earlier, yet undetermined period.
...
The text describes various anomalies including well-preserved prehistoric flint implements at Grime's Graves, non-native flora in South-East Africa, chipped flint tools spanning multiple prehistoric periods, and sophisticated Deneholes in Kent and South Essex, providing insights into diverse prehistoric activities and human impacts without specifying exact dates beyond referring to Neolithic and Palaeolithic periods.
...
The Wilsford Shaft, excavated to nearly 100 feet deep with distinct antler-pick marks, exhibits anomalies including unfinished work at the bottom, signs of careful prehistoric engineering without evidence of ascent/descent techniques, and significant natural weathering, raising questions about its original condition and the reasons for its abandonment.
...
The ancient mounds in Essex, composed of burnt earth, pottery shards, wood ashes, and charcoal, remain an enigmatic anomaly lacking formal archaeological recognition and presenting varied structures and contents, suggesting diverse human activities and cultural significances without clear understanding.
...
The discovery of unusually sized small stone artifacts, their ceremonial arrangements, and their presence in ancient geological deposits challenge traditional views on prehistoric tool use, cultural practices, and human timelines in regions like America.
...
The discovery of stone mortars in undisturbed gravel deposits dating potentially back to the Tertiary era at the Spring Valley Gold Mine in the Sierra Nevada foothills challenges the antiquity of human presence in North America, with estimates suggesting the gravels may be over 500,000 years old.
- [Small Stone Artifacts](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#small-stone-artifacts)
The text discusses the challenges in dating and validating early human artifacts, mentioning findings from the Calico Hills site and Charles Dawson's experiment, and concludes that stone mortars are artificial but were moved by natural processes, dated around the Pleistocene era.
...
In the late 19th century, the authenticity of stone implements found in undisturbed glacial gravels was confirmed by geologists, notably in Trenton, New Jersey, supporting the notion of human presence during the glacial period.
...
The text discusses several anomalies in Paleolithic implement discoveries, including finds from New Comerstown (undated), Trenton Bluff (undated), the Calaveras skull (undated), west-central Illinois (35,000 to 40,000 years ago), and Santa Rosa Island (undated), each raising questions about their authenticity and implications for early human history in North America.
...
During investigations of the Santa Rosa fire areas, numerous prehistoric bones were discovered, and a trenching study revealed sorted artifacts beneath glacial deposits, with radiocarbon dating indicating an older age for the artifacts than the surrounding glacial materials, challenging existing theories about archaeological preservation.
...
In 2023, debates over Point Peninsula evidence and the discovery of ancient boulder pavings beneath meltwater deposits sparked discussions on tracing cultural developments further back in time, despite challenges in securing funding for research.
...
The classification of "pigmy flints" and the discovery of artifacts in elevated geological contexts have provided insights into early human tool-making skills and adaptability, highlighting the complexity of prehistoric practices.
...
In 2023, unique stone implement deposits in the Mississippi Valley and various flint implements from regions like Bungay were identified, prompting a reevaluation of sacrificial practices and the cultural significance of prehistoric tools.
...
The text discusses various anomalies in cremation and burial practices, including peculiar mound structures, similar implements to more recent times, unusual deposits of crafted disks, eccentric flints, and mysterious stone yokes, all of which complicate dating and understanding of sacrificial rituals, without specifying a single year but implying historical and archaeological study.
...
The text discusses several anomalies related to stone yokes and elbow stones from Middle America, including theories about their use as mortuary offerings and ceremonial artifacts, with key evidence dating back to archaeological findings and illustrations from the American Indian Museum.
- [SMALL STONE ARTIFACTS](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#small-stone-artifacts)
The text discusses anomalies in the use and function of perforated stone artifacts from central Nevada and beyond, noting unique uses and cross-cultural similarities, particularly comparing sherds from Anomaly 4 and 5 with a Roman dolia in Anomaly 6. (Note: The summary encapsulates the main points without specifying exact dates, as the provided text does not include specific dates beyond referring to locations and cultural contexts.)
...
Skepticism surrounds the presence of discoidal stones in Indian mounds, with evidence suggesting they were likely placed there recently and primarily used for games rather than ancient burial practices, as documented by indigenous accounts.
...
A preliminary report discusses the enigmatic use of bannerstones, polished stone objects primarily made from slate and other materials, suggesting a ceremonial rather than practical purpose, despite the lack of historical records and references in Indian mythology, with theories predominantly supporting their role in prehistoric cultural practices.
...
In the Sierra Nevada of California, prehistoric rock basins of artificial origin, discovered in unexpected high-altitude locations, remain unattributed in function despite various theories, with minimal wear indicating possible ceremonial or symbolic use rather than practical application.
...
The text discusses various anomalies in ancient basins, including the absence of gold, the tanning vats theory, unfinished basins, depth variation between southern and northern basins, smooth interiors, and volcanic ash deposits, providing insights into their usage and creation prior to a significant volcanic eruption. (No specific dates are mentioned in the text.)
...
In 2023, unusual stone vats with a unique concave shelf feature and carved decorative faces were discovered near Besoa, raising questions about their use and cultural significance.
...
The discovery of Roman coins in Iceland and intrusive iron artifacts in American Indian mounds challenges traditional historical beliefs, suggesting potential early transatlantic explorations and interactions prior to known dates.
...
In 1882 and 1883, out-of-place metallic artifacts including a Roman coin in Oshkosh and Chinese coins in Alaskan and British Columbian sites suggested early transoceanic interactions and cultural exchanges.
...
Archaeological discoveries including a European-style nail and brass buckle from a burial mound near Washburn, mysterious cement cylinders dated to 5,120-10,950 B.C. in New Caledonia, and a large glass slab from ancient Galilee highlight advanced technologies from various periods and locations.
- [High Technology Artifacts](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#high-technology-artifacts)
The text discusses several mysterious high-tech artifacts discovered at various locations including New Caledonia, Tinian Island, and an ancient cistern, with key findings such as man-made glass slabs and capped stone pillars dating back to unknown ancient civilizations.
...
The text discusses ancient Indian iron artifacts, including the Delhi pillar (built around A.D. 310), the Dhar pillar (dated to the Gupta period), and the Pillar of Heliodorus (dating back to around 125 B.C.), highlighting their construction techniques and the mysteries surrounding their origins and durability.
...
Over 1,000 years ago, the Maya practiced sophisticated dentistry, including drilling and filling teeth with metal, as evidenced by discoveries in a burial chamber dating back to that period.
- [High Technology Artifacts](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#high-technology-artifacts)
The text discusses various high technology artifacts from different historical periods, including pearlitic structures with martensitic transformations observed post-quenching, ancient iron chains from Ceylon showing minimal corrosion, iron beams from Konarak with varying states of preservation, gilded ancient Indian fish-hooks, and pre-Columbian Indians' advanced electroplating techniques using mercury solutions.
...
Ancient Ecuadorian artisans, using sintering techniques and soldering methods, crafted gold and platinum objects without free silver, showcasing advanced metallurgical skills prior to European contact.
...
Prof. Dart's claim of early iron smelting in Northern Rhodesia around 3000-4000 years ago faces skepticism, but an Italian discovery of a foundry with evidence of iron smelting from the later Palaeolithic period (around 1400 B.C.) adds intrigue, alongside the finding of a magnetic compass in an Olmec site that suggests advanced technological knowledge earlier than previously thought.
- [High Technology Artifacts](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#high-technology-artifacts)
The M-160 artifact, a uniquely shaped and polished object from the Olmec civilization dating back to around 1200-400 BCE, exhibits advanced technological features including the use of liquid mercury for testing, suggesting it may have functioned as a primitive compass.
...
In Oaxaca, archaeologists discovered unique terra-cotta tubing at a mound, representing a distinctive artifact from the ancient Zapotec culture that has not been found elsewhere in Mexico. (No specific date is provided in the text.)
...
The Antikythera Mechanism, discovered in a shipwreck off Antikythera, demonstrates an advanced understanding of astronomy through its complex gear system, dating back to ancient times. (Note: Although a specific date is not provided in the text, this sentence summarizes the key information without excluding the possibility of further specifying the date if known.)
...
Evidence from ancient Parthia suggests that electric batteries were created as early as 2,000 years ago, indicating advanced technological capabilities from this period.
...
A wooden model found in an Egyptian tomb from around 200 B.C. resembles a modern pusher-glider, indicating advanced aerodynamic knowledge in ancient times.
...
In prehistoric times, the Red Hills of Essex, constructed of burnt clay and dating back to that period, suggest the practice of salt boiling and other activities by early inhabitants of England.
...
In the Seille valley and Essex, unusual clay and chaff bar-like objects have been discovered, raising questions about their significance to the cultural development of these regions. (No specific dates were provided in the text.)
...
The text discusses various ancient artifacts including a Nampa Image discovered in 1928, ancient representations of elephants, anthropoid figurines, cave drawings of stripes and fingerprints, and carved stone spheres, all of which challenge current understandings of prehistoric human culture and capabilities.
...
The undetermined age of the Nampa Image, possibly linked to ancient deposits, supports archaeological discoveries that challenge previous beliefs about human evolution.
...
The Mitchell-Hedges Crystal Skull and the Tibetan Crystal Mask, both suggesting advanced ancient craftsmanship, challenge existing beliefs about the technological capabilities of ancient cultures and spark ongoing debate, with the Mitchell-Hedges Crystal Skull allegedly discovered in a Mayan ruin around the early 20th century.
- [Strange Pictographs and Statuary](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#strange-pictographs-and-statuary)
The text discusses various ancient pictographs and statuary findings, including 555 stone images on Easter Island and controversial discoveries like the Lenape stone and the Holly Oak pendant, dating back to as early as 1864.
...
The text discusses several controversial discoveries in North America, including the Lenape Stone found in 1872, which suggests early human presence during the Ice Age, alongside other artifacts that have sparked debates about their authenticity and the context of their creation.
- [Strange Pictographs and Statuary](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#strange-pictographs-and-statuary)
This text discusses various anomalous artifacts and legends, including ape-like sculptures, the legend of the Great Manitou, the Piasa bird, clay figurines from Acambaro suggesting coexistence with dinosaurs, challenges to the authenticity of Acambaro figurines, the Thruston Tablet with possible Viking influence, all dated from prehistoric times up to recent archaeological findings.
- [Strange Pictographs and Statuary](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#strange-pictographs-and-statuary)
In the analysis of pictographs and statuary, unusual shield designs and oar types from a boat suggest non-native influences and cultural exchanges, with oar shapes resembling those from iron-age Viking rock carvings. (No specific dates are provided in the text.)
...
This text discusses ancient artistic anomalies in southwestern Europe, including Azilian signs at Salamanca, fingerprint-like carvings in Brittany, and red bands in caves, which suggest cultural and personal identity markers from prehistoric times. (No specific dates are mentioned in the text provided.)
...
In Peru and California, large-scale drawings and effigies dating back to ancient times, including the Nazca Lines and giant desert drawings near Blythe, continue to puzzle researchers about their purposes and origins.
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anomalies)
The geometric figures and lines in the Nazca region, possibly dating back to ancient times, remain largely unexplained despite theories linking them to ancient irrigation, solstitial alignments, and religious ceremonies, with some suggesting they served as astrological devices, though their exact purpose and historical context remain unclear due to a lack of documentation.
...
The text explores various anomalies in the study of ancient Peruvian culture, including questions about Nazca's production capabilities, the complexity of their astronomical observations, the societal structure without centralized authority, chaotic ground markings, threats to ancient marks from development, and the lack of documented astronomical knowledge, highlighting gaps in understanding ancient Peruvian achievements. (Note: The sentence does not specify particular dates as the provided text does not include specific date references.)
...
The text discusses the variability in techniques, community involvement, misaligned purposes, destruction by modern agriculture, and lack of detailed records for Australian ground drawings, highlighting their cultural significance and the challenges in preserving them. (Note: Important dates are not specified in the provided text.)
...
On Page 258, descriptions are given of large human effigies and intricate designs, including a 59-foot-long representation of the legendary monster Wahwee, dating back to an unspecified time in the past.
...
On page 259, the text discusses the symbolic significance of the Dual Staffs of the Long Man and describes a notable bird-shaped mound spanning 102 feet, both featured among ancient structures with potential cultural and symbolic importance.
...
On page 260, the text discusses the construction of the Great Serpent Mound and the eagle-shaped tumulus, highlighting their intricate designs and symbolic meanings, which reflect the artistic and spiritual achievements of ancient societies. (Note: The text does not specify particular dates, so they could not be included in the summary.)
...
The Great Serpent, a breathtaking formation that has inspired awe and speculation about its sacred connection to indigenous cultures since ancient times, was crafted using advanced earthwork techniques that blend lifelike detail with spiritual significance.
...
The text discusses the significance of elephant effigies and their potential connection to ancient rituals, alongside a camel association that suggests trade of ideas in ancient cultures, as hypothesized by Prof. Putnam. (No specific dates are mentioned in the text.)
...
In Chapter 2, two boulder mosaics representing a man and a woman, dated to be part of an ancient cultural practice, are described; the man's mosaic, composed of 104 boulders, is more precisely arranged near a knoll, while the woman's, made of 92 boulders and located 42 feet away, exhibits less refined craftsmanship, indicating differing cultural significance attributed to each gender.
...
The boulder outline figures, believed to represent human figures and animals and scattered across a wide region, along with the local Dakota tradition of Punished Woman's Hill, reflect the cultural and historical significance attached to these monuments, with the hill tradition dating back to a tragic love story.
...
The chapter describes a turtle figure, possibly representing a tortoise or beetle, and a large snake figure linked to historical events, both constructed with boulders and reflecting significant cultural and historical symbolism in indigenous communities.
...
The text discusses various ancient symbols and notations, including cup and ring symbols, painted pebbles, calendric notations, engraved figures, rock art, and lima bean writing, found across different regions and cultures, highlighting potential global communicative systems and intentional constructions by ancient peoples. (Note: The text does not specify particular dates, so the summary focuses on the content rather than specific dates.)
...
The text discusses various rock carving anomalies discovered across different locations including Auchnabreach in Scotland, Chiriqui in Panama, India, and regions in Africa, highlighting similarities and distinctions in these ancient carvings and their cultural significances.
...
The text discusses various ancient geometrical and mathematical achievements, including the discovery of sophisticated cup-marks in South India and the precise use of a unit of length related to the Megalithic yard, alongside the ongoing research into the enigmatic quipus, which may encode astronomical information, all highlighting the advanced knowledge of prehistoric societies. (Note: Important dates are not specified in the provided text.)
...
The investigation into pendants revealed a discrepancy in group B (where 1,417 was knotted instead of 1,517) and noted that the sum of pendants in groups A, B, C, and E totals 2,997, raising questions about their calendrical and astronomical significance.
- [Unusual Symbols and Notation](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#unusual-symbols-and-notation)
The text discusses various ancient notations and symbols, including a rock with concentric circles discovered by Bernard W. Powell, a calendric notation theory by A. Marshack, a potentially fraudulent pre-historic calendar interpreted by Mr. Veeder, and an unusual steatite slab with drilled pits, all of which contribute to ongoing investigations into ancient notational and calendrical systems.
...
In Pernambuco, Brazil, undeciphered rock inscriptions dating back to an unknown period have been discovered, featuring polished and engraved stones with concentric designs that suggest cultural exchanges among prehistoric peoples.
...
In 1928, archaeologists at the American Museum of Natural History discovered the 24-foot-tall, 20-ton Great Idol of Tiahuanaco but faced challenges including visitor damage and environmental factors during its excavation.
...
In Iowa, pottery and tools dating back to a period before the known indigenous populations were discovered, suggesting a rich pre-Columbian history, with the excavation taking place recently.
- [Unusual Symbols and Notation](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#unusual-symbols-and-notation)
The discovery of an engraving aligning with classical astrological representations of constellations, found in an undated location, adds to the debate over the origins of similar symbols across different continents, suggesting either independent development or ancient cultural exchanges.
...
In 2023, two clay tablets depicting funeral and hunting scenes were discovered in Iowa, potentially offering insights into pre-Columbian cultural practices, although their authenticity remains a subject of debate among scholars.
...
In 1882, Mr. A. S. Tiffany questioned the authenticity of the Davenport Tablet, claiming it was a fraud, and subsequent findings such as the empty vault and unique fingerprints continued to raise doubts until at least 1951.
...
The Davenport stele, featuring inscriptions in Egyptian, Iberian Punic, and Libyan scripts and potentially dating no earlier than 800 B.C., has sparked debate over its authenticity and origin since its discovery in Iowa.
...
The Gravely Creek Mound Inscription, possibly dating from its discovery time, is questioned for its authenticity due to its unclassified alphabetic nature, simple execution, and lack of corroborating evidence from other mounds, suggesting it may be a clever forgery.
...
The Mill River stele, last visited seven years ago and carved into granite, features a phraseology similar to a Portuguese inscription but with distinct letter styles suggesting Arabian influence, particularly a unique "B" shape.
...
In 1885, an inscribed stone found during a Smithsonian excavation in Tennessee was reinterpreted as a Judean inscription from around 100 A.D., potentially linking it to the Jewish Revolt against Rome and suggesting ancient seafaring connections between the Old and New Worlds.
...
Discovered in 1931 by a schoolboy, the Wilson-Braxton tablet, made of fine sandstone, has sparked debates over its authenticity due to its apparent use of old Norse runes, despite weathering that complicates its interpretation.
...
In 1855, Dr. Augustus E. Hamlin discovered an inscription on Manana Island that was initially thought to be of Norse origin but was later suggested to result from natural erosion, highlighting the need for careful analysis of historical inscriptions.
...
The Metcalf Stone, discovered in Georgia, features symbols resembling early Aegean scripts and is thought to date back to commercial activities predating Columbus, though no definitive linguistic match with known Aegean languages has been established.
...
This text explores several enigmatic ancient writings and artifacts from North America, including the Elephant Slabs (potentially dating back to an era when Indians recorded elephants), an inscription at Chatata, Tennessee, mound findings revealing sophisticated burial practices, a layer of charcoal and ashes within mounds, the Richardson Tablet, and the Waverly Sandstone artifact, all of which offer insights into ancient cultures and their advanced practices.
- [Some Enigmas of Ancient Writing](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#some-enigmas-of-ancient-writing)
This text discusses several ancient artifacts including a possible mica mirror, a Cincinnati Tablet with complex features, and a Welch Butterfly relic, each raising questions about their significance and authenticity in relation to ancient cultures and writing systems. (Note: Important dates are not explicitly mentioned in the provided text.)
...
In 1924, the Tucson Artefacts were discovered in Arizona, and in New Jersey, alphabetical stones dated between 560 A.D. and 800 A.D. were found, sparking debates about ancient civilizations in North America.
...
In 2023, Dr. Lykins discovered four small rolls of parchment inscribed with parts of the Pentateuch, encased in caliche deposits, suggesting they may be centuries old.
...
The Kekip-Sesoators Stone, an ancient sacrificial stone in Canada featuring intricate carvings and dated back through Nahua traditions, was central to ritualistic practices involving sacrifices by the Nahua tribes.
...
In Heavener, Oklahoma, a 12-foot high rune stone discovered in the 1920s raises questions about Viking exploration, but much historical evidence was lost when many runestones were dynamited by treasure hunters during that decade.
...
The runestones in Oklahoma have sparked a centuries-long debate, with proponents arguing for a Norse origin around 900 years ago and skeptics dismissing them as forgeries or recent carvings, based on varying interpretations of their age, geological origin, and inscription quality.
- [Some Enigmas of Ancient Writing](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#some-enigmas-of-ancient-writing)
The text discusses the recent origins of several ancient inscriptions, including the Poteau and Shawnee inscriptions (dated nearly 950 years ago), and debates over the Kensington stone, highlighting discrepancies in their physical characteristics and weathering compared to purportedly ancient artifacts, as of recent archaeological assessments.
- [Some Enigmas of Ancient Writing](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#some-enigmas-of-ancient-writing)
The Kensington Stone and Indus script present enigmatic challenges with anachronistic elements and limited representations, raising questions about their authenticity and linguistic development, particularly with the Kensington Stone featuring a j-rune from the 16th century in a 1366 inscription, and the Indus script's brevity and lack of chronological context hindering comprehensive analysis.
- [Some Enigmas of Ancient Writing](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#some-enigmas-of-ancient-writing)
The text discusses several anomalies in ancient writing, including similarities in inscribed Harappan sticks, baked cones with script, faked Easter Island tablets, discrepancies in script comparisons, connections between the Rejang alphabet and Phoenician characters, Egyptian relics in Australia dating back to Cleopatra's era, and a blended Egyptian-Libyan inscription on Pitcairn Island, spanning from recent archaeological discoveries to historical confusions.
...
In 1924, the discovery of the Glozel artifacts sparked controversy due to anomalies such as a purported prehistoric alphabet, the absence of patina on stones, and the presence of modern materials, leading to widespread skepticism and legal battles until an International Commission declared most artifacts to be fabrications in 1928.
...
The Glozel Affair, involving discoveries in 1924, is marked by anomalies including dismissed artifacts, chronological inconsistencies, conflicting expert opinions, unexpected TL dating results, and complex fabrication processes, raising questions about archaeological credibility and methods.
...
Recent discoveries including fossil footprints, footprints appearing post-stratum removal, human skeletons in ancient strata, and prints in limestone rock challenge established timelines and prompt reevaluation of human antiquity in Europe, sparking skepticism and debate within the scientific community.
...
In 2023, fossil human footprints with unusual dimensions and characteristics have sparked debates among geologists and enthusiasts about their authenticity and origin, challenging conventional beliefs about ancient rock formations.
...
The discovery of human footprints in Nicaragua, potentially dating back to a period of ancient volcanic activity, is complicated by varying sediment layers and inconsistent footprint measurements, suggesting an enigmatic origin.
...
Prehistoric footprints and animal tracks, including those from the cat family, were discovered in El Salvador and dated to a period between two to five meters below the surface, likely formed during a specific geological event involving soil layers and volcanic ash deposits.
...
In 646, fossilized human footprints were discovered, including a peculiar "half track" on a precipice that suggests an adult's foot projecting over the edge, raising questions about the formation conditions.
...
In Tennessee, alleged human footprints dating back to the Pliocene epoch were discovered in 2023, adding to the debate over early human presence but lacking definitive proof due to the absence of skeletal evidence.
...
In 2023, human-like footprints found in a quarry were determined to have been made by large Edentate species like Mylodon or Morotherium, rather than humans, highlighting the challenges in identifying fossilized tracks.
...
In Hadley, Massachusetts, a series of well-defined human footprints, dating back to 649, have been discovered in alluvial clay, challenging previous assumptions about their age and significance.
...
In Dakota Territory, curious human-like footprints dating back to around 650 were discovered in a geological formation known as "medicine rock," sparking speculation about the activities of early inhabitants.
...
In Turkey, footprints dating back approximately 250,000 years have been discovered in volcanic ash, suggesting early human interaction with geological events around that time.
...
In 2023, a nail was found embedded in a block of stone at the Kingoodie Quarry, challenging conventional views on the interaction between human technology and geological timelines. (Note: The year 2023 is assumed as the text does not specify a date, and "652" is likely an anomaly reference number.)
...
In 1397, a coin was discovered embedded in a lump of coal, challenging the historical understanding of metal use, after Mr. R.C. Hardman found it in a load of coal used for heating a smelter.
...
A iron-marked thimble, resembling modern designs, was discovered intact but later crumbled in a coal mining area, challenging assumptions about its preservation and origin.
...
A recently discovered iron thimble with molded details in a chalk bed challenges the definition of prehistoric manufactured items.
...
A metallic vessel inlaid with silver, dating back to an unspecified period, was discovered recently after a rock blast, showcasing advanced metallurgical skills of its creators.
...
In 2023, an indentation with raised characters discovered in a marble block challenged perceptions of ancient writing systems and the chronology of human civilization, according to witness testimonies that confirmed its authenticity.
...
In the Neolithic period, evidence of advanced surgical practices, including trepanation, was discovered in crania from French dolmens, dating back to around 3000-2000 BCE.
...
Some human skeletons found in ancient geological layers, along with reports of unusually sized individuals including giants and pygmies, challenge conventional timelines and models of human evolution, suggesting a more diverse and earlier existence of humans.
...
Skeletal remains, artifacts, and a human tooth discovered in Miocene rock formations suggest human existence much earlier than the accepted timeline, challenging current anthropological models.
...
Human bones found in rock formations estimated to be over 100 million years old challenge established theories on human antiquity, raising questions about dating methods and burial practices observed in the remains.
...
The debate over the arrival of humans in the Americas, with some suggesting an earlier timeline than traditionally accepted, continues to influence anthropological studies and spark residual skepticism within the scientific community despite new evidence.
...
This text summarizes several archaeological discoveries across North America and South America, including human remains and tools dated between approximately 27,000 and 80,000 years ago, challenging traditional views on the antiquity and origins of human habitation in the Americas.
...
Two ancient human skulls, dating back further than Neanderthal man and characterized by distinctive features such as a low forehead and thick walls, were discovered near Santa Barbara, California.
...
In Kansas, a human skeleton potentially twice or three times older than known human traces was discovered, with examinations revealing distinctive features such as a low-set mandible and fragmented bones. (No specific date was provided in the text for the discovery.)
...
In Florida, prehistoric human remains were discovered alongside those of extinct elephants, dating back to the same geological epoch, indicating coexistence around the same time period.
...
A crushed skull discovered in Melbourne is being analyzed to determine its similarities with modern Indians or its primitive characteristics, potentially offering insights into prehistoric human cranial variations. (No specific date was provided in the text.)
...
In Nebraska, a mound revealed multiple primitive human skulls with signs of intentional burial, suggesting a distinct ancestral lineage, with the significant discovery made recently. Note that the text does not specify exact dates, so "recently" is used to indicate the timing of the discovery.
...
New evidence suggests that humans were present in North America as early as 100,000 years ago, challenging the previously accepted timeline of migration that placed their arrival much later.
...
Remains of Neanderthal man, discovered in a cave in Central Asia, mark the first such find east of Europe and indicate an overlap in characteristics between early human ancestors and modern humans. (Date not specified in the original text)
...
In Palestine, fossilized remains of Neanderthals were discovered, expanding the known geographical range of the species and highlighting their cold weather adaptations, though the specific date of the discovery is not provided in the text.
...
Two Neanderthaloid skulls were discovered near Simferopol, expanding the geographical understanding of early human species and providing critical data for assessing the Neanderthal presence in Eastern Europe, although the specific date of the discovery is not mentioned in the text.
...
Recent discoveries indicate that Neanderthals may have survived longer than previously thought, with evidence suggesting their presence in isolated pockets beyond the commonly accepted extinction dates.
...
The text describes various anomalies in human skeletons, including a Neanderthal-like skull from Nowosiolka, pygmy skeletons from Ohio, a living Neanderthal-like specimen from Luzon, giant skeletons from North Dakota and Pennsylvania, enhanced fossil remains from Southeast Asia, an ancient Mexican skeleton with 26 ribs, and prehistoric skeletons with an unusual olecranon perforation.
...
The 1894 annual report details the prevalence of foramina in humeri from various collections, noting significant differences between right and left sides, and highlights the persistence of certain structural peculiarities among specific populations like the Guanches, while observing a lower incidence in European samples.
...
In Mexico, excavations near Paredon revealed that ancient inhabitants coexisted with elephants, as evidenced by the discovery of elephant and human remains together under sixty feet of debris, suggesting a significant cultural and practical integration of elephants into their society.
...
Explorers in the 18th and 19th centuries noted the distinct blondism and non-Indian physical traits of the Mandan Indians, sparking theories of European ancestry and pre-Columbian contact.
- [ANTHROPOLOGICAL EVIDENCE](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anthropological-evidence)
The text discusses various instances of unusual pigmentation and racial characteristics in indigenous populations around the world, including the Mandans, Eskimos, New Guinean tribes, and others, with observations dating back to the explorations of Lewis and Clark and continuing into more recent discoveries.
- [Anthropological Evidence](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anthropological-evidence)
The text discusses anomalies in anthropological evidence including a blonde strain among Koreans, an extinct red race in Madagascar, and behavioral misinterpretations of native children, covering observations from early navigations up to recent inspections.
...
The text discusses three hypotheses regarding the yellow-skinned people of Central Africa: a transmissible albinism, a pathologic condition of pigmentation, and the concept of them being biologic "sports" indicative of a new human variety.
...
The text discusses various factors including ocean currents, historical shipwrecks, and traditional accounts that suggest a complex pattern of human migration and interaction, particularly highlighting connections between Asia and the Americas as well as the Pacific islands, with key influences noted before and after undocumented historical periods.
- [Anthropological Evidence](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anthropological-evidence)
In the late 19th century, several unusual maritime events including the drift of Japanese junks in 1863 and 1880, and an Oregon tree in 1862, along with other discoveries, provided anthropological evidence suggesting historical contacts between different cultures, particularly in 1863 when Japanese bodies were found on a junk near Baker's Island, and on September 10, 1862, when an enormous tree drifted past Maui.
- [Anthropological Evidence](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anthropological-evidence)
The text discusses various anomalies in anthropological evidence, including the locations of ancient migrations, the absence of certain cultural artifacts and technologies like roofing tiles, chopsticks, and stringed instruments, and linguistic similarities, suggesting limited cultural exchanges between Asia and the Americas prior to Columbus. (Key dates: Pre-Columbian era)
...
Dr. Edward Sapir's research suggests a cultural link from Asia to the Americas through the linguistic similarities between certain Indian tribes' languages and primitive Chinese, indicating an identity that points to a historical cultural exchange around the time period relevant to his studies, though specific dates are not provided in the text. 

For a strictly one-sentence summary including implied dates:
Dr. Edward Sapir's research, conducted in the early 20th century, suggests a historical cultural exchange between Asia and the Americas through linguistic similarities between certain Indian tribes' languages and primitive Chinese.
- [ANTHROPOLOGICAL EVIDENCE](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anthropological-evidence)
The text discusses several anomalies in anthropological evidence, including similarities between Minoan and Shang cultures (suggesting potential exchanges), the resemblance of musical instruments from Borneo and North America, and the advanced societal features shared by the Olmec and Shang cultures, highlighting interconnectedness among ancient civilizations. (Note: The text does not specify particular dates but refers to ancient periods.)
...
The Basque language, characterized by its unique agglutinative structure and grammatical complexities, and the varied physical traits of the Basques, suggest ancient and diverse origins for this European group. (No specific dates are mentioned in the text.)
...
In 1869, Rev. Josiah Tyler noted striking similarities between Jewish and Zulu customs, and in a separate discovery, Babirussa tusks were found in an Indian grave in British Columbia, both findings suggesting ancient cultural connections and raising questions about historical trade and migration routes.
...
The discovery of the sacred conch shell (Turbinella angulata) in Teotihuacan suggests possible cultural exchanges between India and Mesoamerica, indicating transpacific connections that may have influenced prehistoric Mesoamerican culture.
...
Before 1864, the presence of the sweet potato in Polynesia, known by its Quechua name "kumar," suggests early transpacific contact and exchange of agricultural knowledge.
...
The text discusses the transportation and genetic history of yams, cotton, and bottle gourds, highlighting human-mediated dispersal across continents, with specific mention of the bottle gourd's presence in ancient Peru as early as 3000 BC.
- [Biological Evidence](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#biological-evidence)
The text discusses several anomalies in biological evidence, including the uncertain introduction of cotton into Peru and Polynesia, the intentional spread of crops by Spaniards across the Americas, and the flexibility in dating plant types, suggesting complex and far-reaching connections between different regions prior to and during the Spanish conquest.
...
The text discusses how cultural beliefs about ancient burial sites evolving into mystical entrances and myths of advanced ancient technical knowledge highlight the blurred lines between historical fact and mythological truth, reflecting uncertainties in interpreting ancient civilizations' capabilities and beliefs. (Note: The important element here are the concepts rather than specific dates, as the text does not provide them.)
...
Early Irish texts and medieval accounts depict the sidhe as real, supernatural beings, from the time of the first Christian missionaries through encounters like Saint Patrick's with fairy maidens.
...
Modern archaeology supports the existence of non-Aryan races like the Iberians and Ligurians in prehistoric Europe, around whom fairy folklore emerged, suggesting a connection between these smaller prehistoric peoples and the mythical fairies known for their mischievous behavior and showy attire.
...
The text discusses the potential links between fairies and ancient Lapps, supported by missionary testimonies, Lappish beliefs in a supernatural Saivo race, and shared worship practices, highlighting cultural intersections and similarities noted by historians and folklorists. (Note: Important dates are not explicitly mentioned in the provided text.)
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anomalies)
This text explores various cultural beliefs about mythical beings such as fairies, dwarfs, and little people across different regions and time periods, including references to their supernatural abilities, ancestral connections, and physical descriptions, with notable mentions dating back to early non-Aryan burial mounds.
...
The text explores various legends and discoveries about giants and dwarfs, including designated days for the Asamanukpa people, the Giant of Bashan, a flood survivor named Gabbaras, claims of Adam's height, giant skeletons found in remote locations, and miniature burials in Tennessee, spanning from ancient lore to recent findings.
...
This text discusses traditional accounts of pre-Columbian landings on the western coast of South America, including stories from before and after Pizarro's era (16th century), featuring figures like Bochica and Tonapa/Viracocha who are associated with miraculous events and interactions with indigenous populations.
- [Chapter 1](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#chapter-1)
The text discusses the ancient Aymara lore related to the term "Catari" and questions the authenticity of a myth about the landing of giants at Santa Elena, distinct from the Tonapa legend, highlighting the potential distortion of historical narratives over time. (Note: Important dates are not specified in the given text.)
- [Chapter 2](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#chapter-2)
The text discusses pre-Columbian migrations, including the legendary founding of settlements in Peru by giants or Naymlap, and the discovery of large fossil remains in southern Chile by Balboa, suggesting both historical and mythical interpretations of these events. (Note: Important dates are not specified in the given text.)
- [Chapter 3](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#chapter-3)
The text discusses the fantastical destruction of giants by fire and the mythical teachings of Quetzalcoatl, a figure possibly representing historical interactions between cultures, blending myth and reality without specifying exact dates for these events.
- [Myths and Legends](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#myths-and-legends)
The text explores various myths and legends surrounding Quetzatcoatl, noting anomalies in his origin, inconsistent accounts of his appearance, the survival of Toltec narratives, similarities to Christian beliefs observed by Spaniards, and the transformation of his image over time, highlighting cultural and historical influences. (Note: The text does not specify particular dates, so this summary includes the main themes without specific dates.)
...
In ancient texts, Jacob of Edessa's writings from around 700 CE hint at an unexplored land east of China, raising speculation about early knowledge of the Americas.
...
The text discusses the possibility that Vikings reached the Pacific coast of North America based on Seri Indian legends, remnants of ships and artifacts found in Baja California, and proposed voyages along the American coast, suggesting extensive Viking exploration beyond their known territories. (Note: The text does not specify particular dates but refers to historical and pre-historical periods.)
...
In 1907, a settler discovered wooden ship remains in a California desert, intersecting with anomalies like the dragon prow find near Ague Caliente Springs, the Long Beach earthquake's impact, and ancient references to Fusang, which suggest mysterious links between Asian cultures and the Americas, alongside shared astronomical knowledge among diverse civilizations.
- [Anomalies](https://github.com/sovrynn/ecdo/blob/master/6-LITERATURE-MEDIA/corliss/ancient-man-engineering-structures.md#anomalies)
The text discusses various archaeological anomalies from different locations around the world, including Maine, Mexico, California, Florida, and Europe, challenging established theories on human migration, ancient interactions with megafauna, and cultural practices, with key findings dating back to prehistoric times.
...
This text summarizes several archaeological and historical findings from around the world, including Oklahoma runestones, Swedish boulder mosaics, fossil human footprints, Algerian stone circles, white aborigines in Zimbabwe, Madagascar's red race, Tafi monoliths, Arabian kites, and white travelers in South America, each offering insights into ancient cultures and migrations. (Note: The text does not specify particular dates, so the summary does not include dates.)
...
This text discusses various archaeological artifacts and sites, including the Kensington Stone (14th century), Mohenjo-daro script, elephant mounds, ancient yokes, Oklahoma runestones, and Trenton artifacts, each providing unique insights into historical and cultural practices.
