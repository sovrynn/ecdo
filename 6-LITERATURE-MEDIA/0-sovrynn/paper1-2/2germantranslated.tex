...
% Wenn hyperref auskommentiert und dann wieder einkommentiert word, sollte
% egpaper.aux gelöscht werden, bevor latex erneut ausgeführt wird. (Oder drücke einfach 'q' beim ersten latex-
% Durchlauf, lass es fertig laufen, und alles sollte in Ordnung sein.)

\usepackage[breaklinks=true,bookmarks=false]{hyperref}

\cvprfinalcopy % *** Diese Zeile für die letztendliche Einreichung unkommentieren

\def\cvprPaperID{****} % *** CVPR Paper ID hier eingeben
...
% lass die folgenden Zeilen bis zum abschließenden ``}'' weg.
...
% \Abschnitt{Zusätzliche Anomalien, die am besten durch eine Erdumkehrung erklärt werden}

% Bevor wir zum Schluss kommen, möchte ich noch einige weitere wissenschaftliche Anomalien erwähnen, die gut verständlich sind, wenn man sie im Kontext der kataklysmischen geophysikalischen Kräfte betrachtet.
