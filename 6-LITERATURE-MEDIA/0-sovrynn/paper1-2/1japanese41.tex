...
% \end{center}
%    \caption{クフ王ピラミッドの内部シャフトと部屋。Ethical Skepticは、これが三分割された地球物理学的観測所であったと考えている。}
% \label{fig:1}
% \label{fig:onecol}
% \end{figure}
