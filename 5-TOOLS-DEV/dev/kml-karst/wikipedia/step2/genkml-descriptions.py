...
MARKER_ICON = "http://maps.google.com/mapfiles/kml/shapes/triangle.png"
...
MARKER_COLOR = "ffff0000"
MARKER_COLOR = "ff00ffff" # yellow
MARKER_COLOR = "ffff0000"
# Name of the KML output file
KML_FILENAME = "karst-areas-no-label.kml"
KML_NAME = "Karst Areas"
...
def main():
    ...
    for i in range(len(linesX)):
        ...
        # kml_content.append(f"      <name>Karst Areas: {location_name}</name>")
        kml_content.append(f"""      <description>
        <![CDATA[
          <p><b>Karst Area: </b> {location_name}</p>
          <p>Source: https://en.wikipedia.org/wiki/List_of_karst_areas</p>
        ]]>
      </description>""")
