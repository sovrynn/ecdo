...
def main():
    ...
    # Set the title
    plt.title('Flood Myths (TalkOrigins) and ECDO Rotation Path', fontsize=28, pad=20)
    ...
    # footer_text = "Flood Myth Source: TalkOrigins"
    ...
    if use_marker:
        add_point_kml((x,y),kml, marker_size, color='blue')
        add_point_kml(dest,kml, marker_size, color='blue')
