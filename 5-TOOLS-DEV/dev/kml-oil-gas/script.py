...
# MARKER_ICON = "http://maps.google.com/mapfiles/kml/shapes/shaded_dot.png"
...
MARKER_COLOR = "ff2a2a96" # reddish brown
MARKER_COLOR = "ff036f96" # briht yellow brown
MARKER_COLOR = "ff004f6b" #muddy brown
KML_OUTPUT_FILENAME = "oil-gas-deposits.kml"
KML_NAME = "Oil and Gas Deposits"
# ========================
...
def main():
    ...
    try:
        with open(csv_filename, mode='r', encoding='utf-8-sig') as csvfile:
            ...
            required_columns = ["Latitude", "Longitude", "Unit Name", "Wiki URL"]
            ...
            for row_number, row in enumerate(reader, start=2):  # start=2 to account for headers in line 1
                ...
                description_html = f"""
<p><b>Oil and Gas Deposit: {mine_name}</b></p>
<p>Source: {wiki_url}</p>
""".strip()
